...
goog.userAgent.isDocumentMode=goog.userAgent.isDocumentModeOrHigher;goog.userAgent.DOCUMENT_MODE=function(){var a=goog.global.document,b=goog.userAgent.getDocumentMode_();return a&&goog.userAgent.IE?b||("CSS1Compat"==a.compatMode?parseInt(goog.userAgent.VERSION,10):5):void 0}();goog.dom.BrowserFeature={CAN_ADD_NAME_OR_TYPE_ATTRIBUTES:!goog.userAgent.IE||goog.userAgent.isDocumentModeOrHigher(9),CAN_USE_CHILDREN_ATTRIBUTE:!goog.userAgent.GECKO&&!goog.userAgent.IE||goog.userAgent.IE&&goog.userAgent.isDocumentModeOrHigher(9)||goog.userAgent.GECKO&&goog.userAgent.isVersionOrHigher("1.9.1"),CAN_USE_INNER_TEXT:goog.userAgent.IE&&!goog.userAgent.isVersionOrHigher("9"),CAN_USE_PARENT_ELEMENT_PROPERTY:goog.userAgent.IE||goog.userAgent.OPERA||goog.userAgent.WEBKIT,INNER_HTML_NEEDS_SCOPED_ELEMENT:goog.userAgent.IE,
...
goog.functions.throttle=function(a,b,c){c&&(a=goog.bind(a,c));var d=null,e=!1,f=[],g=function(){d=null;e&&(e=!1,h())},h=function(){d=goog.global.setTimeout(g,b);a.apply(null,f)};return function(a){f=arguments;d?e=!0:h()}};goog.async.throwException=function(a){goog.global.setTimeout(function(){throw a;},0)};
...
goog.inherits(goog.ui.Control.IeMouseEventSequenceSimulator_,goog.Disposable);goog.ui.Control.IeMouseEventSequenceSimulator_.prototype.handleMouseDown_=function(){this.clickExpected_=!1};goog.ui.Control.IeMouseEventSequenceSimulator_.prototype.handleMouseUp_=function(){this.clickExpected_=!0};
...
goog.ui.ac.AutoComplete.prototype.renderRows=function(a,b){var c="object"==goog.typeOf(b)&&b,d=(c?c.getPreserveHilited():b)?this.getIndexOfId(this.hiliteId_):-1;this.firstRowId_+=this.rows_.length;this.rows_=a;for(var e=[],f=0;f<a.length;++f)e.push({id:this.getIdOfIndex_(f),data:a[f]});f=null;this.target_&&(f=this.inputToAnchorMap_[goog.getUid(this.target_)]||this.target_);this.renderer_.setAnchorElement(f);this.renderer_.renderRows(e,this.token_,this.target_);f=this.autoHilite_;c&&void 0!==c.getAutoHilite()&&
(f=c.getAutoHilite());this.hiliteId_=-1;(f||0<=d)&&0!=e.length&&this.token_&&(0<=d?this.hiliteId(this.getIdOfIndex_(d)):this.hiliteNext());this.dispatchEvent(goog.ui.ac.AutoComplete.EventType.SUGGESTIONS_UPDATE)};goog.ui.ac.AutoComplete.prototype.getIndexOfId=function(a){a-=this.firstRowId_;return 0>a||a>=this.rows_.length?-1:a};goog.ui.ac.AutoComplete.prototype.getIdOfIndex_=function(a){return this.firstRowId_+a};
...
goog.ui.ac.AutoComplete.prototype.update=function(a){this.selectionHandler_.update(a)};goog.dom.InputType={BUTTON:"button",CHECKBOX:"checkbox",COLOR:"color",DATE:"date",DATETIME:"datetime",DATETIME_LOCAL:"datetime-local",EMAIL:"email",FILE:"file",HIDDEN:"hidden",IMAGE:"image",MENU:"menu",MONTH:"month",NUMBER:"number",PASSWORD:"password",RADIO:"radio",RANGE:"range",RESET:"reset",SEARCH:"search",SELECT_MULTIPLE:"select-multiple",SELECT_ONE:"select-one",SUBMIT:"submit",TEL:"tel",TEXT:"text",TEXTAREA:"textarea",TIME:"time",URL:"url",WEEK:"week"};goog.dom.selection={};goog.dom.selection.setStart=function(a,b){if(goog.dom.selection.useSelectionProperties_(a))a.selectionStart=b;else if(goog.userAgent.IE){var c=goog.dom.selection.getRangeIe_(a),d=c[0];d.inRange(c[1])&&(b=goog.dom.selection.canonicalizePositionIe_(a,b),d.collapse(!0),d.move("character",b),d.select())}};goog.dom.selection.getStart=function(a){return goog.dom.selection.getEndPoints_(a,!0)[0]};
...
goog.dom.selection.setText=function(a,b){if(goog.dom.selection.useSelectionProperties_(a)){var c=a.value,d=a.selectionStart,e=c.substr(0,d),c=c.substr(a.selectionEnd);a.value=e+b+c;a.selectionStart=d;a.selectionEnd=d+b.length}else if(goog.userAgent.IE)e=goog.dom.selection.getRangeIe_(a),d=e[1],e[0].inRange(d)&&(e=d.duplicate(),d.text=b,d.setEndPoint("StartToStart",e),d.select());else throw Error("Cannot set the selection end");};
goog.dom.selection.getText=function(a){if(goog.dom.selection.useSelectionProperties_(a))return a.value.substring(a.selectionStart,a.selectionEnd);if(goog.userAgent.IE){var b=goog.dom.selection.getRangeIe_(a),c=b[1];return b[0].inRange(c)?a.type==goog.dom.InputType.TEXTAREA?goog.dom.selection.getSelectionRangeText_(c):c.text:""}throw Error("Cannot get the selection text");};
...
goog.dom.selection.canonicalizePositionIe_=function(a,b){if(a.type==goog.dom.InputType.TEXTAREA){var c=a.value.substring(0,b);b=goog.string.canonicalizeNewlines(c).length}return b};goog.dom.selection.useSelectionProperties_=function(a){try{return"number"==typeof a.selectionStart}catch(b){return!1}};goog.userAgent.product={};goog.userAgent.product.ASSUME_FIREFOX=!1;goog.userAgent.product.ASSUME_IPHONE=!1;goog.userAgent.product.ASSUME_IPAD=!1;goog.userAgent.product.ASSUME_ANDROID=!1;goog.userAgent.product.ASSUME_CHROME=!1;goog.userAgent.product.ASSUME_SAFARI=!1;
...
goog.ui.ac.InputHandler.prototype.attachInput=function(a){goog.dom.isElement(a)&&goog.a11y.aria.setState(a,"haspopup",!0);this.eh_.listen(a,goog.events.EventType.FOCUS,this.handleFocus);this.eh_.listen(a,goog.events.EventType.BLUR,this.handleBlur);if(!this.activeElement_&&(this.activateHandler_.listen(a,goog.events.EventType.KEYDOWN,this.onKeyDownOnInactiveElement_),goog.dom.isElement(a))){var b=goog.dom.getOwnerDocument(a);goog.dom.getActiveElement(b)==a&&this.processFocus(a)}};
goog.ui.ac.InputHandler.prototype.detachInput=function(a){a==this.activeElement_&&this.handleBlur();this.eh_.unlisten(a,goog.events.EventType.FOCUS,this.handleFocus);this.eh_.unlisten(a,goog.events.EventType.BLUR,this.handleBlur);this.activeElement_||this.activateHandler_.unlisten(a,goog.events.EventType.KEYDOWN,this.onKeyDownOnInactiveElement_)};goog.ui.ac.InputHandler.prototype.attachInputs=function(a){for(var b=0;b<arguments.length;b++)this.attachInput(arguments[b])};
goog.ui.ac.InputHandler.prototype.detachInputs=function(a){for(var b=0;b<arguments.length;b++)this.detachInput(arguments[b])};goog.ui.ac.InputHandler.prototype.selectRow=function(a,b){this.activeElement_&&this.setTokenText(a.toString(),b);return!1};
goog.ui.ac.InputHandler.prototype.setTokenText=function(a,b){if(goog.isDef(b)?b:this.multi_){var c=this.getTokenIndex_(this.getValue(),this.getCursorPosition()),d=this.splitInput_(this.getValue()),e=a;this.separatorCheck_.test(e)||(e=goog.string.trimRight(e)+this.defaultSeparator_);this.whitespaceWrapEntries_&&(0==c||goog.string.isEmptyOrWhitespace(d[c-1])||(e=" "+e),c==d.length-1&&(e+=" "));if(e!=d[c]){d[c]=e;e=this.activeElement_;(goog.userAgent.GECKO||goog.userAgent.IE&&goog.userAgent.isVersionOrHigher("9"))&&
e.blur();e.value=d.join("");for(var f=0,g=0;g<=c;g++)f+=d[g].length;e.focus();this.setCursorPosition(f)}}else this.setValue(a);this.rowJustSelected_=!0};goog.ui.ac.InputHandler.prototype.disposeInternal=function(){goog.ui.ac.InputHandler.superClass_.disposeInternal.call(this);null!=this.activeTimeoutId_&&window.clearTimeout(this.activeTimeoutId_);this.eh_.dispose();delete this.eh_;this.activateHandler_.dispose();this.keyHandler_.dispose();goog.dispose(this.timer_)};
goog.ui.ac.InputHandler.prototype.setSeparators=function(a,b){this.separators_=a;this.defaultSeparator_=goog.isDefAndNotNull(b)?b:this.separators_.substring(0,1);var c=this.multi_?"[\\s"+this.separators_+"]+":"[\\s]+";this.trimmer_=new RegExp("^"+c+"|"+c+"$","g");this.separatorCheck_=new RegExp("\\s*["+this.separators_+"]$")};goog.ui.ac.InputHandler.prototype.setUpsideDown=function(a){this.upsideDown_=a};
goog.ui.ac.InputHandler.prototype.setWhitespaceWrapEntries=function(a){this.whitespaceWrapEntries_=a};goog.ui.ac.InputHandler.prototype.setGenerateNewTokenOnLiteral=function(a){this.generateNewTokenOnLiteral_=a};goog.ui.ac.InputHandler.prototype.setTrimmingRegExp=function(a){this.trimmer_=a};goog.ui.ac.InputHandler.prototype.setPreventDefaultOnTab=function(a){this.preventDefaultOnTab_=a};goog.ui.ac.InputHandler.prototype.setPreventSelectionOnTab=function(a){this.preventSelectionOnTab_=a};
...
goog.ui.ac.InputHandler.prototype.getTokenIndex_=function(a,b){var c=this.splitInput_(a);if(b==a.length)return c.length-1;for(var d=0,e=0,f=0;e<c.length&&f<=b;e++)f+=c[e].length,d=e;return d};
goog.ui.ac.InputHandler.prototype.splitInput_=function(a){if(!this.multi_)return[a];a=String(a).split("");for(var b=[],c=[],d=0,e=!1;d<a.length;d++)this.literals_&&-1!=this.literals_.indexOf(a[d])?(this.generateNewTokenOnLiteral_&&!e&&(b.push(c.join("")),c.length=0),c.push(a[d]),e=!e):e||-1==this.separators_.indexOf(a[d])?c.push(a[d]):(c.push(a[d]),b.push(c.join("")),c.length=0);b.push(c.join(""));return b};goog.fx={};goog.fx.Transition=function(){};goog.fx.Transition.EventType={PLAY:"play",BEGIN:"begin",RESUME:"resume",END:"end",STOP:"stop",FINISH:"finish",PAUSE:"pause"};goog.fx.TransitionBase=function(){goog.events.EventTarget.call(this);this.state_=goog.fx.TransitionBase.State.STOPPED;this.endTime=this.startTime=null};goog.inherits(goog.fx.TransitionBase,goog.events.EventTarget);goog.fx.TransitionBase.State={STOPPED:0,PAUSED:-1,PLAYING:1};goog.fx.TransitionBase.prototype.getStateInternal=function(){return this.state_};goog.fx.TransitionBase.prototype.setStatePlaying=function(){this.state_=goog.fx.TransitionBase.State.PLAYING};
...
goog.fx.AnimationEvent.prototype.coordsAsInts=function(){return goog.array.map(this.coords,Math.round)};goog.style.bidi={};goog.style.bidi.getScrollLeft=function(a){var b=goog.style.isRightToLeft(a);return b&&goog.userAgent.GECKO?-a.scrollLeft:!b||goog.userAgent.IE&&goog.userAgent.isVersionOrHigher("8")||"visible"==goog.style.getComputedOverflowX(a)?a.scrollLeft:a.scrollWidth-a.clientWidth-a.scrollLeft};
...
goog.positioning.positionAtAnchor=function(a,b,c,d,e,f,g,h,k){goog.asserts.assert(c);var l=goog.positioning.getOffsetParentPageOffset(c),n=goog.positioning.getVisiblePart_(a);goog.style.translateRectForAnotherFrame(n,goog.dom.getDomHelper(a),goog.dom.getDomHelper(c));a=goog.positioning.getEffectiveCorner(a,b);n=new goog.math.Coordinate(a&goog.positioning.CornerBit.RIGHT?n.left+n.width:n.left,a&goog.positioning.CornerBit.BOTTOM?n.top+n.height:n.top);n=goog.math.Coordinate.difference(n,l);e&&(n.x+=
(a&goog.positioning.CornerBit.RIGHT?-1:1)*e.x,n.y+=(a&goog.positioning.CornerBit.BOTTOM?-1:1)*e.y);var m;if(g)if(k)m=k;else if(m=goog.style.getVisibleRectForElement(c))m.top-=l.y,m.right-=l.x,m.bottom-=l.y,m.left-=l.x;return goog.positioning.positionAtCoordinate(n,c,d,f,m,g,h)};
...
goog.positioning.getPositionAtCoordinate=function(a,b,c,d,e,f){a=a.clone();b=b.clone();var g=goog.positioning.OverflowStatus.NONE;if(d||c!=goog.positioning.Corner.TOP_LEFT)c&goog.positioning.CornerBit.RIGHT?a.x-=b.width+(d?d.right:0):d&&(a.x+=d.left),c&goog.positioning.CornerBit.BOTTOM?a.y-=b.height+(d?d.bottom:0):d&&(a.y+=d.top);f&&(g=e?goog.positioning.adjustForViewport_(a,b,e,f):goog.positioning.OverflowStatus.FAILED_OUTSIDE_VIEWPORT);c=new goog.math.Rect(0,0,0,0);c.left=a.x;c.top=a.y;c.width=
b.width;c.height=b.height;return{rect:c,status:g}};
...
(f=a.x,a.x<c.left&&(a.x=c.left,e|=goog.positioning.OverflowStatus.WIDTH_ADJUSTED),a.x+b.width>c.right&&(b.width=Math.min(c.right-a.x,f+b.width-c.left),b.width=Math.max(b.width,0),e|=goog.positioning.OverflowStatus.WIDTH_ADJUSTED));a.x+b.width>c.right&&d&goog.positioning.Overflow.ADJUST_X&&(a.x=Math.max(c.right-b.width,c.left),e|=goog.positioning.OverflowStatus.ADJUSTED_X);d&goog.positioning.Overflow.FAIL_X&&(e=e|(a.x<c.left?goog.positioning.OverflowStatus.FAILED_LEFT:0)|(a.x+b.width>c.right?goog.positioning.OverflowStatus.FAILED_RIGHT:
...
d&goog.positioning.Overflow.FAIL_Y&&(e=e|(a.y<c.top?goog.positioning.OverflowStatus.FAILED_TOP:0)|(a.y+b.height>c.bottom?goog.positioning.OverflowStatus.FAILED_BOTTOM:0));return e};goog.positioning.getEffectiveCorner=function(a,b){return(b&goog.positioning.CornerBit.FLIP_RTL&&goog.style.isRightToLeft(a)?b^goog.positioning.CornerBit.RIGHT:b)&~goog.positioning.CornerBit.FLIP_RTL};goog.positioning.flipCornerHorizontal=function(a){return a^goog.positioning.CornerBit.RIGHT};
goog.positioning.flipCornerVertical=function(a){return a^goog.positioning.CornerBit.BOTTOM};goog.positioning.flipCorner=function(a){return a^goog.positioning.CornerBit.BOTTOM^goog.positioning.CornerBit.RIGHT};goog.ui.ac.Renderer=function(a,b,c,d){goog.events.EventTarget.call(this);this.parent_=a||goog.dom.getDocument().body;this.dom_=goog.dom.getDomHelper(this.parent_);this.reposition_=!a;this.element_=null;this.token_="";this.rows_=[];this.rowDivs_=[];this.startRenderingRows_=this.hilitedRow_=-1;this.visible_=!1;this.className="ac-renderer";this.rowClassName="ac-row";this.legacyActiveClassName_="active";this.activeClassName="ac-active";this.highlightedClassName="ac-highlighted";this.customRenderer_=b||
null;this.useStandardHighlighting_=null!=d?d:!0;this.matchWordBoundary_=!0;this.highlightAllTokens_=!1;this.rightAlign_=!!c;this.topAlign_=!1;this.menuFadeDuration_=0;this.showScrollbarsIfTooLarge_=!1};goog.inherits(goog.ui.ac.Renderer,goog.events.EventTarget);goog.ui.ac.Renderer.DELAY_BEFORE_MOUSEOVER=300;goog.ui.ac.Renderer.prototype.getElement=function(){return this.element_};goog.ui.ac.Renderer.prototype.setWidthProvider=function(a){this.widthProvider_=a};
goog.ui.ac.Renderer.prototype.setTopAlign=function(a){this.topAlign_=a};goog.ui.ac.Renderer.prototype.getTopAlign=function(){return this.topAlign_};goog.ui.ac.Renderer.prototype.setRightAlign=function(a){this.rightAlign_=a};goog.ui.ac.Renderer.prototype.getRightAlign=function(){return this.rightAlign_};goog.ui.ac.Renderer.prototype.setShowScrollbarsIfTooLarge=function(a){this.showScrollbarsIfTooLarge_=a};
goog.ui.ac.Renderer.prototype.setUseStandardHighlighting=function(a){this.useStandardHighlighting_=a};goog.ui.ac.Renderer.prototype.setMatchWordBoundary=function(a){this.matchWordBoundary_=a};goog.ui.ac.Renderer.prototype.setHighlightAllTokens=function(a){this.highlightAllTokens_=a};goog.ui.ac.Renderer.prototype.setMenuFadeDuration=function(a){this.menuFadeDuration_=a};goog.ui.ac.Renderer.prototype.setAnchorElement=function(a){this.anchorElement_=a};
goog.ui.ac.Renderer.prototype.getAnchorElement=function(){return this.anchorElement_};goog.ui.ac.Renderer.prototype.renderRows=function(a,b,c){this.token_=b;this.rows_=a;this.hilitedRow_=-1;this.startRenderingRows_=goog.now();this.target_=c;this.rowDivs_=[];this.redraw()};
goog.ui.ac.Renderer.prototype.dismiss=function(){this.target_&&goog.a11y.aria.setActiveDescendant(this.target_,null);this.visible_&&(this.visible_=!1,this.target_&&goog.a11y.aria.setState(this.target_,goog.a11y.aria.State.HASPOPUP,!1),0<this.menuFadeDuration_?(goog.dispose(this.animation_),this.animation_=new goog.fx.dom.FadeOutAndHide(this.element_,this.menuFadeDuration_),this.animation_.play()):goog.style.setElementShown(this.element_,!1))};
goog.ui.ac.Renderer.prototype.show=function(){this.visible_||(this.visible_=!0,this.target_&&(goog.a11y.aria.setRole(this.target_,goog.a11y.aria.Role.COMBOBOX),goog.a11y.aria.setState(this.target_,goog.a11y.aria.State.AUTOCOMPLETE,"list"),goog.a11y.aria.setState(this.target_,goog.a11y.aria.State.HASPOPUP,!0)),0<this.menuFadeDuration_?(goog.dispose(this.animation_),this.animation_=new goog.fx.dom.FadeInAndShow(this.element_,this.menuFadeDuration_),this.animation_.play()):goog.style.setElementShown(this.element_,
!0))};goog.ui.ac.Renderer.prototype.isVisible=function(){return this.visible_};
...
goog.ui.ac.Renderer.prototype.redraw=function(){this.maybeCreateElement_();this.topAlign_&&(this.element_.style.visibility="hidden");this.widthProvider_&&(this.element_.style.minWidth=this.widthProvider_.clientWidth+"px");this.rowDivs_.length=0;this.dom_.removeChildren(this.element_);if(this.customRenderer_&&this.customRenderer_.render)this.customRenderer_.render(this,this.element_,this.rows_,this.token_);else{var a=null;goog.array.forEach(this.rows_,function(b){b=this.renderRowHtml(b,this.token_);
this.topAlign_?this.element_.insertBefore(b,a):this.dom_.appendChild(this.element_,b);a=b},this)}0==this.rows_.length?this.dismiss():(this.show(),this.reposition(),goog.style.setUnselectable(this.element_,!0))};goog.ui.ac.Renderer.prototype.getAnchorCorner=function(){var a=this.rightAlign_?goog.positioning.Corner.BOTTOM_RIGHT:goog.positioning.Corner.BOTTOM_LEFT;this.topAlign_&&(a=goog.positioning.flipCornerVertical(a));return a};
...
goog.ui.ac.Renderer.prototype.hiliteMatchingText_=function(a,b){if(this.highlightAllTokens_||!this.wasHighlightedAtLeastOnce_)if(a.nodeType==goog.dom.NodeType.TEXT){var c=null;goog.isArray(b)&&1<b.length&&!this.highlightAllTokens_&&(c=goog.array.slice(b,1));var d=this.getTokenRegExp_(b);if(0!=d.length){for(var e=a.nodeValue,f=this.matchWordBoundary_?new RegExp("\\b(?:"+d+")","gi"):new RegExp(d,"gi"),d=[],g=0,h=f.exec(e),k=0;h;)k++,d.push(e.substring(g,h.index)),d.push(e.substring(h.index,f.lastIndex)),
g=f.lastIndex,h=f.exec(e);d.push(e.substring(g));if(1<d.length){c=this.highlightAllTokens_?k:1;for(e=0;e<c;e++)f=2*e,a.nodeValue=d[f],g=this.dom_.createElement(goog.dom.TagName.B),g.className=this.highlightedClassName,this.dom_.appendChild(g,this.dom_.createTextNode(d[f+1])),g=a.parentNode.insertBefore(g,a.nextSibling),a.parentNode.insertBefore(this.dom_.createTextNode(""),g.nextSibling),a=g.nextSibling;d=goog.array.slice(d,2*c);a.nodeValue=d.join("");this.wasHighlightedAtLeastOnce_=!0}else c&&this.hiliteMatchingText_(a,
c)}}else for(d=a.firstChild;d;)c=d.nextSibling,this.hiliteMatchingText_(d,b),d=c};
...
goog.ui.ac.Renderer.prototype.renderRowHtml=function(a,b){var c=this.dom_.createDom(goog.dom.TagName.DIV,{className:this.rowClassName,id:goog.ui.IdGenerator.getInstance().getNextUniqueId()});goog.a11y.aria.setRole(c,goog.a11y.aria.Role.OPTION);this.customRenderer_&&this.customRenderer_.renderRow?this.customRenderer_.renderRow(a,b,c):this.renderRowContents_(a,b,c);b&&this.useStandardHighlighting_&&this.startHiliteMatchingText_(c,b);goog.dom.classlist.add(c,this.rowClassName);this.rowDivs_.push(c);
return c};goog.ui.ac.Renderer.prototype.getRowFromEventTarget_=function(a){for(;a&&a!=this.element_&&!goog.dom.classlist.contains(a,this.rowClassName);)a=a.parentNode;return a?goog.array.indexOf(this.rowDivs_,a):-1};goog.ui.ac.Renderer.prototype.handleClick_=function(a){var b=this.getRowFromEventTarget_(a.target);0<=b&&this.dispatchEvent({type:goog.ui.ac.AutoComplete.EventType.SELECT,row:this.rows_[b].id});a.stopPropagation()};
goog.ui.ac.Renderer.prototype.handleMouseDown_=function(a){a.stopPropagation();a.preventDefault()};goog.ui.ac.Renderer.prototype.handleMouseOver_=function(a){a=this.getRowFromEventTarget_(a.target);0<=a&&!(goog.now()-this.startRenderingRows_<goog.ui.ac.Renderer.DELAY_BEFORE_MOUSEOVER)&&this.dispatchEvent({type:goog.ui.ac.AutoComplete.EventType.HILITE,row:this.rows_[a].id})};goog.ui.ac.Renderer.CustomRenderer=function(){};goog.ui.ac.Renderer.CustomRenderer.prototype.render=function(a,b,c,d){};
goog.ui.ac.Renderer.CustomRenderer.prototype.renderRow=function(a,b,c){};goog.ui.ac.createSimpleAutoComplete=function(a,b,c,d){a=new goog.ui.ac.ArrayMatcher(a,!d);d=new goog.ui.ac.Renderer;c=new goog.ui.ac.InputHandler(null,null,!!c);a=new goog.ui.ac.AutoComplete(a,d,c);c.attachAutoComplete(a);c.attachInputs(b);return a};
...
Blockly.Workspace.prototype.getWidth=function(){return 0};Blockly.Workspace.prototype.getBlockById=function(a){for(var b=this.getAllBlocks(),c=0,d;d=b[c];c++)if(d.id==a)return d;return null};Blockly.Workspace.prototype.getBlocksByType=function(a){for(var b=[],c=this.getAllBlocks(),d=0,e;e=c[d];d++)e.type==a&&b.push(e);return b};Blockly.Workspace.prototype.remainingCapacity=function(){return isNaN(this.options.maxBlocks)?Infinity:this.options.maxBlocks-this.getAllBlocks().length};
...
Blockly.Bubble.prototype.dispose=function(){Blockly.Bubble.unbindDragEvents_();goog.dom.removeNode(this.bubbleGroup_);this.shape_=this.content_=this.workspace_=this.resizeGroup_=this.bubbleBack_=this.bubbleArrow_=this.bubbleGroup_=null};Blockly.Icon=function(a){this.block_=a};Blockly.Icon.prototype.collapseHidden=!0;Blockly.Icon.prototype.SIZE=17;Blockly.Icon.prototype.png_="";Blockly.Icon.prototype.bubble_=null;Blockly.Icon.prototype.iconX_=0;Blockly.Icon.prototype.iconY_=0;
...
Blockly.Icon.prototype.iconClick_=function(a){2!=Blockly.dragMode_&&(this.block_.isInFlyout||Blockly.isRightButton(a)||this.setVisible(!this.isVisible()))};Blockly.Icon.prototype.updateColour=function(){if(this.isVisible()){var a=Blockly.makeColour(this.block_.getColour());this.bubble_.setColour(a)}};
...
Blockly.Connection.prototype.closest=function(a,b,c){function d(b){b=e[b];if((b.type==Blockly.OUTPUT_VALUE||b.type==Blockly.PREVIOUS_STATEMENT)&&b.targetConnection||b.type==Blockly.INPUT_VALUE&&b.targetConnection&&!b.targetBlock().isMovable()&&!b.targetBlock().isShadow()||!n.checkType_(b))return!0;var c=b.sourceBlock_;do{if(l==c)return!0;c=c.getParent()}while(c);var d=f-b.x_,c=g-b.y_,d=Math.sqrt(d*d+c*c);d<=a&&(k=b,a=d);return Math.abs(c)<a}if(this.targetConnection)return{connection:null,radius:a};
var e=this.dbOpposite_,f=this.x_+b,g=this.y_+c;b=0;for(var h=c=e.length-2;b<h;)e[h].y_<g?b=h:c=h,h=Math.floor((b+c)/2);c=b=h;var k=null,l=this.sourceBlock_,n=this;if(e.length){for(;0<=b&&d(b);)b--;do c++;while(c<e.length&&d(c))}return{connection:k,radius:a}};
Blockly.Connection.prototype.checkType_=function(a){var b=this.targetBlock();if(b&&!b.isMovable()&&!this.sourceBlock_.isMovable()||(b=a.targetBlock())&&!b.isMovable()&&!a.sourceBlock_.isMovable())return!1;if(!this.check_||!a.check_)return!this.check_&&!a.requireType_||!a.check_&&!this.requireType_;for(b=0;b<this.check_.length;b++)if(-1!=a.check_.indexOf(this.check_[b]))return!0;return!1};
Blockly.Connection.prototype.setCheck=function(a,b){a?(goog.isArray(a)||(a=[a]),this.check_=a,this.requireType_=!!b,this.targetConnection&&!this.checkType_(this.targetConnection)&&(this.isSuperior()?this.targetBlock().setParent(null):this.sourceBlock_.setParent(null),this.sourceBlock_.bumpNeighbours_())):this.check_=null;return this};Blockly.Connection.prototype.setShadowDom=function(a){this.shadowDom_=a};Blockly.Connection.prototype.getShadowDom=function(){return this.shadowDom_};
...
Blockly.Connection.prototype.hideAll=function(){this.setHidden(!0);if(this.targetConnection)for(var a=this.targetBlock().getDescendants(),b=0;b<a.length;b++){for(var c=a[b],d=c.getConnections_(!0),e=0;e<d.length;e++)d[e].setHidden(!0);c=c.getIcons(!0);for(d=0;d<c.length;d++)c[d].setVisible(!1)}};
...
Blockly.ConnectionDB.init=function(a){var b=[];b[Blockly.INPUT_VALUE]=new Blockly.ConnectionDB;b[Blockly.OUTPUT_VALUE]=new Blockly.ConnectionDB;b[Blockly.NEXT_STATEMENT]=new Blockly.ConnectionDB;b[Blockly.PREVIOUS_STATEMENT]=new Blockly.ConnectionDB;a.connectionDBList=b};Blockly.Field=function(a){this.size_=new goog.math.Size(0,25);this.setText(a)};Blockly.Field.cacheWidths_=null;Blockly.Field.cacheReference_=0;Blockly.Field.prototype.maxDisplayLength=50;Blockly.Field.prototype.sourceBlock_=null;Blockly.Field.prototype.visible_=!0;Blockly.Field.prototype.changeHandler_=null;Blockly.Field.prototype.privateData_=null;Blockly.Field.NBSP="\u00a0";Blockly.Field.prototype.EDITABLE=!0;Blockly.Field.prototype.SERIALIZABLE=!0;
...
Blockly.Field.prototype.setVisible=function(a){if(this.visible_!=a){this.visible_=a;var b=this.getSvgRoot();b&&(b.style.display=a?"block":"none",this.render_())}};Blockly.Field.prototype.setChangeHandler=function(a){this.changeHandler_=a};Blockly.Field.prototype.setSerializable=function(a){this.SERIALIZABLE=a};Blockly.Field.prototype.getSvgRoot=function(){return this.fieldGroup_};
...
Blockly.Field.prototype.setValue=function(a){this.setText(a)};Blockly.Field.prototype.getPrivate=function(){return this.privateData_};Blockly.Field.prototype.setPrivate=function(a){this.privateData_=a};Blockly.Field.prototype.onMouseUp_=function(a){if(!goog.userAgent.IPHONE&&!goog.userAgent.IPAD||goog.userAgent.isVersionOrHigher("537.51.2")||0===a.layerX||0===a.layerY)Blockly.isRightButton(a)||2!=Blockly.dragMode_&&this.sourceBlock_.isEditable()&&this.showEditor_()};
...
Blockly.Xml.blockToDom_=function(a){var b=goog.dom.createDom(a.isShadow()?"shadow":"block");b.setAttribute("type",a.type);Blockly.Realtime.isEnabled()&&b.setAttribute("id",a.id);if(a.mutationToDom){var c=a.mutationToDom();c&&(c.hasChildNodes()||c.hasAttributes())&&b.appendChild(c)}for(var c=0,d;d=a.inputList[c];c++)for(var e=0,f;f=d.fieldRow[e];e++)if(f.name&&f.SERIALIZABLE){var g=goog.dom.createDom("field",null,f.getValue());g.setAttribute("name",f.name);b.appendChild(g)}if(c=a.getCommentText())c=
...
b.setAttribute("editable",!1);if(c=a.getNextBlock())h=goog.dom.createDom("next",null,Blockly.Xml.blockToDom_(c)),b.appendChild(h);e=a.nextConnection&&a.nextConnection.getShadowDom();!e||c&&c.isShadow()||h.appendChild(Blockly.Xml.cloneShadow_(e));return b};
...
Blockly.WorkspaceSvg=function(a){Blockly.WorkspaceSvg.superClass_.constructor.call(this,a);this.getMetrics=a.getMetrics;this.setMetrics=a.setMetrics;Blockly.ConnectionDB.init(this);this.SOUNDS_=Object.create(null);this.eventWrappers_=[]};goog.inherits(Blockly.WorkspaceSvg,Blockly.Workspace);Blockly.WorkspaceSvg.prototype.rendered=!0;Blockly.WorkspaceSvg.prototype.isFlyout=!1;Blockly.WorkspaceSvg.prototype.isScrolling=!1;Blockly.WorkspaceSvg.prototype.scrollX=0;
Blockly.WorkspaceSvg.prototype.scrollY=0;Blockly.WorkspaceSvg.prototype.startScrollX=0;Blockly.WorkspaceSvg.prototype.startScrollY=0;Blockly.WorkspaceSvg.prototype.dragDeltaX_=0;Blockly.WorkspaceSvg.prototype.dragDeltaY_=0;Blockly.WorkspaceSvg.prototype.scale=1;Blockly.WorkspaceSvg.prototype.trashcan=null;Blockly.WorkspaceSvg.prototype.scrollbar=null;
...
Blockly.WorkspaceSvg.prototype.dispose=function(){this.rendered=!1;Blockly.unbindEvent_(this.eventWrappers_);Blockly.WorkspaceSvg.superClass_.dispose.call(this);this.svgGroup_&&(goog.dom.removeNode(this.svgGroup_),this.svgGroup_=null);this.svgBubbleCanvas_=this.svgBlockCanvas_=null;this.flyout_&&(this.flyout_.dispose(),this.flyout_=null);this.trashcan&&(this.trashcan.dispose(),this.trashcan=null);this.scrollbar&&(this.scrollbar.dispose(),this.scrollbar=null);this.zoomControls_&&(this.zoomControls_.dispose(),
this.zoomControls_=null);this.options.parentWorkspace||goog.dom.removeNode(this.options.svg)};Blockly.WorkspaceSvg.prototype.addTrashcan_=function(a){this.trashcan=new Blockly.Trashcan(this);var b=this.trashcan.createDom();this.svgGroup_.insertBefore(b,this.svgBlockCanvas_);return this.trashcan.init(a)};Blockly.WorkspaceSvg.prototype.addZoomControls_=function(a){this.zoomControls_=new Blockly.ZoomControls(this);var b=this.zoomControls_.createDom();this.svgGroup_.appendChild(b);return this.zoomControls_.init(a)};
Blockly.WorkspaceSvg.prototype.addFlyout_=function(){this.flyout_=new Blockly.Flyout({disabledPatternId:this.options.disabledPatternId,parentWorkspace:this,RTL:this.RTL});this.flyout_.autoClose=!1;var a=this.flyout_.createDom();this.svgGroup_.insertBefore(a,this.svgBlockCanvas_)};
...
};Blockly.WorkspaceSvg.prototype.addChangeListener=function(a){a=Blockly.bindEvent_(this.getCanvas(),"blocklyWorkspaceChange",null,a);Array.prototype.push.apply(this.eventWrappers_,a);return a};Blockly.WorkspaceSvg.prototype.removeChangeListener=function(a){Blockly.unbindEvent_(a);a=this.eventWrappers_.indexOf(a);-1!=a&&this.eventWrappers_.splice(a,1)};
...
Blockly.FieldClickImage.prototype.updateEditable=function(){this.sourceBlock_.isInFlyout||!this.EDITABLE?Blockly.addClass_(this.fieldGroup_,"blocklyIconGroupReadonly"):Blockly.removeClass_(this.fieldGroup_,"blocklyIconGroupReadonly")};
...
Blockly.FieldDropdown.prototype.dispose=function(){Blockly.WidgetDiv.hideIfOwner(this);Blockly.FieldDropdown.superClass_.dispose.call(this)};Blockly.Msg={};goog.getMsgOrig=goog.getMsg;goog.getMsg=function(a,b){var c=goog.getMsg.blocklyMsgMap[a];c&&(a=Blockly.Msg[c]);return goog.getMsgOrig(a,b)};goog.getMsg.blocklyMsgMap={Today:"TODAY"};Blockly.ScopeVariables={};Blockly.ScopeVariables.NAME_TYPE="SCOPEVARIABLE";Blockly.ScopeVariables.allVariables=function(a,b){var c;if(a.getDescendants)c=a.getDescendants();else if(a.getAllBlocks)c=a.getAllBlocks();else throw"Not Block or Workspace: "+a;for(var d=Object.create(null),e=0;e<c.length;e++){var f=c[e].getScopeVars;if(f)for(var g=0;g<b.length;g++)for(var h=f.call(c[e],b[g]),k=0;k<h.length;k++){var l=h[k];l&&(d[l.toLowerCase()]=l)}}c=[];for(var n in d)c.push(d[n]);return c};
Blockly.ScopeVariables.renameVariable=function(a,b,c,d){c=c.getAllBlocks();for(var e=0;e<c.length;e++){var f=c[e].renameScopeVar;if(f)for(var g=0;g<d.length;g++)f.call(c[e],a,b,d[g])}};
Blockly.ScopeVariables.flyoutCategory=function(a,b,c,d,e){e=Blockly.ScopeVariables.allVariables(d.targetWorkspace,e);e.sort();e.unshift(null);for(var f=void 0,g=0;g<e.length;g++)if(e[g]!==f){var h=Blockly.Blocks.variables_get?Blockly.Block.obtain(d,"variables_get"):null;h&&h.initSvg();var k=Blockly.Blocks.variables_set?Blockly.Block.obtain(d,"variables_set"):null;k&&k.initSvg();null===e[g]?f=(h||k).getVars()[0]:(h&&h.setFieldValue(e[g],"VAR"),k&&k.setFieldValue(e[g],"VAR"));k&&a.push(k);h&&a.push(h);
h&&k?b.push(c,3*c):b.push(2*c)}};Blockly.ScopeVariables.generateUniqueName=function(a,b){var c=Blockly.ScopeVariables.allVariables(a,b),d="";if(c.length)for(var e=1,f=-1,g=b[0];!d;){for(var h=!1,k=0;k<c.length;k++)if(c[k].toLowerCase()==g){h=!0;break}h?(f++,25==f&&(f=0,e++),g=b[0]+"ijkmnopqrstuvwxyzabcdefgh".charAt(f),1<e&&(g+=e)):d=g}else d="i";return d};Blockly.FieldScopeVariable=function(a,b){this.msgRename_=Blockly.Msg.RENAME_SCOPE_VARIABLE;this.msgRenameTitle_=Blockly.Msg.RENAME_SCOPE_VARIABLE_TITLE;this.msgNew_=Blockly.Msg.NEW_SCOPE_VARIABLE;this.msgNewTitle_=Blockly.Msg.NEW_SCOPE_VARIABLE_TITLE;this.msgEmpty_=null;this.setVarClass(a);this.setValue(this.getVarClass()[0]);Blockly.FieldScopeVariable.superClass_.constructor.call(this,Blockly.FieldScopeVariable.dropdownCreate,b)};goog.inherits(Blockly.FieldScopeVariable,Blockly.FieldDropdown);
Blockly.FieldScopeVariable.prototype.setChangeHandler=function(a){Blockly.FieldScopeVariable.superClass_.setChangeHandler.call(this,a?function(b){var c=Blockly.FieldScopeVariable.dropdownChange.call(this,b);b=void 0===c?b:null===c?this.getValue():c;a.call(this,b);return c}:Blockly.FieldScopeVariable.dropdownChange)};
Blockly.FieldScopeVariable.prototype.init=function(a){this.sourceBlock_||(this.getValue()||this.msgEmpty_||this.setValue(Blockly.ScopeVariables.generateUniqueName(a.isInFlyout?a.workspace.targetWorkspace:a.workspace,this.getVarClass())),Blockly.FieldScopeVariable.superClass_.init.call(this,a))};Blockly.FieldScopeVariable.prototype.getValue=function(){return this.getText()};Blockly.FieldScopeVariable.prototype.setValue=function(a){this.value_=a;this.setText(a)};
Blockly.FieldScopeVariable.prototype.getVarClass=function(){return this.varClass_};Blockly.FieldScopeVariable.prototype.setVarClass=function(a){this.varClass_="string"===typeof a?[a]:a};Blockly.FieldScopeVariable.prototype.setMsgStrings=function(a,b,c,d){this.msgRename_=a;this.msgRenameTitle_=b;this.msgNew_=c;this.msgNewTitle_=d};Blockly.FieldScopeVariable.prototype.setMsgEmpty=function(a){this.msgEmpty_=a};
Blockly.FieldScopeVariable.dropdownCreate=function(){var a=this.sourceBlock_&&this.sourceBlock_.workspace?Blockly.ScopeVariables.allVariables(this.sourceBlock_.workspace,this.getVarClass()):[],b=Blockly.scopeVariableList[this.getVarClass()];"function"===typeof b?b=b():"undefined"===typeof b&&(b=[]);var c=this.getText();c&&""!==c&&-1==a.indexOf(c)&&a.push(c);a.sort(goog.string.caseInsensitiveCompare);for(var d=0;d<b.length;d++)goog.array.contains(a,b[d])||a.push(b[d]);c&&this.msgRename_&&!goog.array.contains(b,
c)&&a.push(this.msgRename_);this.msgNew_&&a.push(this.msgNew_);goog.array.isEmpty(a)&&a.push("");b=[];this.msgEmpty_&&b.push([this.msgEmpty_,""]);for(c=0;c<a.length;c++)b.push([a[c],a[c]]);return b};
Blockly.FieldScopeVariable.dropdownChange=function(a){function b(a,b){Blockly.hideChaff();var d=window.prompt(a,b);d&&(d=d.replace(/[\s\xa0]+/g," ").replace(/^ | $/g,""),d===c.msgRename_||d===c.msgNew_)&&(d=null);return d}var c=this,d=this.sourceBlock_.workspace;if(a===this.msgRename_){var e=this.getText();(a=b(this.msgRenameTitle_.replace("%1",e),e))&&Blockly.ScopeVariables.renameVariable(e,a,d,this.getVarClass());return null}if(a===this.msgNew_)return(a=b(this.msgNewTitle_,""))?(Blockly.ScopeVariables.renameVariable(a,
a,d,this.getVarClass()),a):null};Blockly.Block=function(){goog.asserts.assert(0==arguments.length,"Please use Blockly.Block.obtain.")};Blockly.Block.obtain=function(a,b){if(Blockly.Realtime.isEnabled())return Blockly.Realtime.obtainBlock(a,b);var c=a.rendered?new Blockly.BlockSvg:new Blockly.Block;c.initialize(a,b);return c};Blockly.Block.prototype.data=null;Blockly.Block.prototype.initialize=function(a,b){this.id=Blockly.Blocks.genUid();a.addTopBlock(this);this.fill(a,b)};
...
Blockly.Block.prototype.getDirectChildren=function(){for(var a=this.getChildren(),b=[],c=0,d;d=a[c];c++)d&&d.getSurroundParent()==this&&b.push(d);return b};Blockly.Block.prototype.getOrderedChildren=function(){for(var a=this.getChildren(),b=[],c=0,d;d=this.inputList[c];c++)if(d&&d.connection&&(d=d.connection.targetBlock())){var e=goog.array.indexOf(a,d);goog.asserts.assert(0<=e,"Input not in children list.");b.push(d)}return b};
...
Blockly.Block.prototype.setPreviousStatement=function(a,b,c){this.previousConnection&&(goog.asserts.assert(!this.previousConnection.targetConnection,"Must disconnect previous statement before removing connection."),this.previousConnection.dispose(),this.previousConnection=null);a&&(goog.asserts.assert(!this.outputConnection,"Remove output connection prior to adding previous connection."),void 0===b&&(b=null),this.previousConnection=new Blockly.Connection(this,Blockly.PREVIOUS_STATEMENT),this.previousConnection.setCheck(b,
c));this.rendered&&(this.render(),this.bumpNeighbours_())};Blockly.Block.prototype.setNextStatement=function(a,b,c){this.nextConnection&&(goog.asserts.assert(!this.nextConnection.targetConnection,"Must disconnect next statement before removing connection."),this.nextConnection.dispose(),this.nextConnection=null);a&&(void 0===b&&(b=null),this.nextConnection=new Blockly.Connection(this,Blockly.NEXT_STATEMENT),this.nextConnection.setCheck(b,c));this.rendered&&(this.render(),this.bumpNeighbours_())};
Blockly.Block.prototype.getInputCollectionOutput=function(a,b,c){c||(c=[b]);if(a=this.getInputTargetBlock(a)){var d=a.getOutput();if(d){for(a=0;a<d.length;a++)d[a]=b+":"+d[a];goog.array.isEmpty(c)?c=d:(c=Blockly.Variables.Intersection(c,d),goog.array.isEmpty(c)&&(c=[b]))}}return c};Blockly.Block.prototype.getOutput=function(){var a=[];this.outputConnection&&(a=this.outputConnection.check_.slice());return a};
Blockly.Block.prototype.setOutput=function(a,b,c){this.outputConnection&&(goog.asserts.assert(!this.outputConnection.targetConnection,"Must disconnect output value before removing connection."),this.outputConnection.dispose(),this.outputConnection=null);a&&(goog.asserts.assert(!this.previousConnection,"Remove previous connection prior to adding output connection."),void 0===b&&(b=null),this.outputConnection=new Blockly.Connection(this,Blockly.OUTPUT_VALUE),this.outputConnection.setCheck(b,c));this.rendered&&
(this.render(),this.bumpNeighbours_())};Blockly.Block.prototype.setInputsInline=function(a){this.inputsInline=a;this.rendered&&(this.render(),this.bumpNeighbours_(),this.workspace.fireChangeEvent())};
...
Blockly.Block.prototype.getInheritedDisabled=function(){for(var a=this;;){var b=a,a=a.getSurroundParent();if(!a){if(!this.workspace.options.disableDisconnected)return!1;for(;null!=b.previousConnection&&null!=b.previousConnection.targetConnection;)b=b.previousConnection.targetConnection.sourceBlock_;return!(b.isTopLevel||b.isInFlyout)}if(a.disabled)return!0}};Blockly.Block.prototype.isCollapsed=function(){return this.collapsed_};Blockly.Block.prototype.setCollapsed=function(a){this.collapsed_=a};
...
(b={type:"input_dummy"},c&&(b.align=c),a.push(b));c={LEFT:Blockly.ALIGN_LEFT,RIGHT:Blockly.ALIGN_RIGHT,CENTRE:Blockly.ALIGN_CENTRE};d=[];for(g=0;g<a.length;g++)if(e=a[g],"string"==typeof e)d.push([e,void 0]);else{b=f=null;do switch(h=!1,e.type){case "input_value":b=this.appendValueInput(e.name);break;case "input_statement":b=this.appendStatementInput(e.name);break;case "input_dummy":b=this.appendDummyInput(e.name);break;case "input_addsub":d.length&&(b=this.appendDummyInput());this.appendAddSubGroup(e.title,
e.name,e.checks);break;case "input_addsubmulti":d.length&&(b=this.appendDummyInput());this.appendAddSubMulti(e.title,e.name,e.checks);break;case "field_label":f=new Blockly.FieldLabel(e.text);break;case "field_input":f=new Blockly.FieldTextInput(e.text);"boolean"==typeof e.spellcheck&&f.setSpellcheck(e.spellcheck);break;case "field_angle":f=new Blockly.FieldAngle(e.angle);break;case "field_checkbox":f=new Blockly.FieldCheckbox(e.checked?"TRUE":"FALSE");break;case "field_colour":f=new Blockly.FieldColour(e.colour);
break;case "field_variable":f=new Blockly.FieldVariable(e.variable);break;case "field_scopevariable":f=new Blockly.FieldScopeVariable(e.scope);break;case "field_dropdown":f=new Blockly.FieldDropdown(e.options);break;case "field_clickimage":f=new Blockly.FieldClickImage(e.src,e.width,e.height,e.alt,e.handler);break;case "field_description":f=new Blockly.FieldDescription;break;case "field_image":f=new Blockly.FieldImage(e.src,e.width,e.height,e.alt);break;case "field_date":if(Blockly.FieldDate){f=new Blockly.FieldDate(e.date);
break}default:e.alt&&(e=e.alt,h=!0)}while(h);if(f)d.push([f,e.name]);else if(b){e.check&&b.setCheck(e.check,e.requireType);e.align&&b.setAlign(c[e.align]);for(e=0;e<d.length;e++)b.appendField(d[e][0],d[e][1]);d.length=0}}};Blockly.Block.prototype.appendInput_=function(a,b){var c=null;if(a==Blockly.INPUT_VALUE||a==Blockly.NEXT_STATEMENT)c=new Blockly.Connection(this,a);c=new Blockly.Input(a,b,this,c);this.inputList.push(c);this.rendered&&(this.render(),this.bumpNeighbours_());return c};
...
Blockly.Block.prototype.doAddField=function(a){a=a.getPrivate().name;var b=this.getItemCount();b[a]++;this.setItemCount(a,b[a]);1==b[a]&&this.removeInput(this.getAddSubName(a,0),!0);this.updateAddSubShape()};
Blockly.Block.prototype.doRemoveField=function(a){var b=a.getPrivate();a=b.name;var c=b.pos,d=this.getItemCount(),b=d[a],e=1;this.titles_[a]&&(e=0);d[a]>e&&(d[a]--,this.setItemCount(a,d[a]));0==d[a]&&this.removeInput(this.getAddSubName(a,0),!0);(d=this.getInput(this.getAddSubName(a,c)))&&d.connection&&d.connection.targetConnection&&d.connection.targetConnection.sourceBlock_.unplug(!0,!0);for(c+=1;c<b;c++)if(e=this.getInput(this.getAddSubName(a,c)),null!=e){if(e.connection&&e.connection.targetConnection){var f=
e.connection.targetConnection;f.sourceBlock_.unplug(!1,!1);d.connection.connect(f)}d=e}this.updateAddSubShape()};Blockly.Block.prototype.setAddSubInfo=function(a,b,c,d){if(a=this.getField(a))a.setChangeHandler(b),a.setPrivate({name:c,pos:d})};Blockly.Block.prototype.getAddSubName=function(a,b){return a+b};Blockly.Block.prototype.getItemCount=function(){return{items:this.itemCount_}};Blockly.Block.prototype.setItemCount=function(a,b){"items"===a&&(this.itemCount_=b)};
Blockly.Block.prototype.appendAddSubEmptyInput=function(a,b){var c=this.appendDummyInput(a);b&&c.appendField(b);return c};
Blockly.Block.prototype.appendAddSubInput=function(a,b,c){var d=this.getAddSubName(a,b),e=null,f=null;this.getItemCount()[a]?(e=this.appendValueInput(d).setCheck(this.checks_[a],!!this.checks_[a]).setAlign(Blockly.ALIGN_RIGHT),c&&e.appendField(c)):(c="",this.titles_[a]&&(c=this.titles_[a].empty),e=this.appendAddSubEmptyInput(d,c));0===b?(f=new Blockly.FieldClickImage(this.addPng,17,17,Blockly.Msg.CLICK_ADD_TOOLTIP),f.setChangeHandler(this.doAddField)):(f=new Blockly.FieldClickImage(this.subPng,17,
17,Blockly.Msg.CLICK_REMOVE_TOOLTIP),f.setChangeHandler(this.doRemoveField));f.setPrivate({name:a,pos:b});e.appendField(f);return[e]};
Blockly.Block.prototype.updateAddSubShape=function(){var a=this.getItemCount(),b;for(b in a)if(a.hasOwnProperty(b)){for(var c=a[b],d=this.getAddSubName(b,c);null!=this.getInput(d);)this.removeInput(d),c++,d=this.getAddSubName(b,c);if(a[b]){var d=this.getAddSubName(b,0),e=this.getInputIndex(d);-1==e&&(c="",this.titles_[b]&&(c=this.titles_[b].normal),this.appendAddSubInput(b,0,c),e=this.getInputIndex(d),goog.asserts.assert(-1!=e,'Named input "%s" not found.',d));if(-1!==e)for(e++,c=1;c<a[b];c++,e++){var f=
this.getAddSubName(b,c),f=this.getInput(f);if(null==f&&(f=this.appendAddSubInput(b,c),e<this.inputList.length-1))for(var g=0;g<f.length;g++)this.moveNumberedInputBefore(this.inputList.length-1,e)}f=this.getInput(d);c=d+"_sub";d=this.getField(c);1===a[b]?d&&f.removeField(c):d||(d=new Blockly.FieldClickImage(this.subPng,17,17,Blockly.Msg.CLICK_REMOVE_TOOLTIP),d.setPrivate({name:b,pos:0}),d.setChangeHandler(this.doRemoveField),f.appendField(d,c))}else d=this.getAddSubName(b,0),c="",this.titles_[b]&&
(c=this.titles_[b].empty),this.removeInput(d,!0),this.appendAddSubInput(b,0,c)}this.rendered&&(this.render(),this.bumpNeighbours_(),this.workspace.fireChangeEvent())};Blockly.Block.prototype.domToMutationAddSub=function(a){var b=this.getItemCount(),c;for(c in b)b.hasOwnProperty(c)&&this.setItemCount(c,parseInt(a.getAttribute(c),10));this.updateAddSubShape()};
Blockly.Block.prototype.mutationToDomAddSub=function(){var a=document.createElement("mutation"),b=this.getItemCount(),c;for(c in b)b.hasOwnProperty(c)&&a.setAttribute(c,b[c]);return a};
...
Blockly.BlockSvg.prototype.initSvg=function(){goog.asserts.assert(this.workspace.rendered,"Workspace is headless.");for(var a=0,b=this.getInputsInline()&&!this.isCollapsed(),c,d=void 0,e=[],f,g=0,h;h=this.inputList[g];g++)b&&d&&d!=Blockly.NEXT_STATEMENT&&h.type!=Blockly.NEXT_STATEMENT?f=e[e.length-1]:(d=h.type,f=[],f.type=b&&h.type!=Blockly.NEXT_STATEMENT?Blockly.BlockSvg.INLINE:h.type,f.height=0,e.push(f)),f.push(h),f.type!=Blockly.INPUT_VALUE&&f.type==Blockly.DUMMY_INPUT&&(c=!0),this.isInFlyout&&
c&&this.inputList[g].type==Blockly.INPUT_VALUE&&!b&&(a++,a==numberArgumentsForBlock?h.fieldRow[0].text_="<More>...":a>numberArgumentsForBlock&&h.setVisible(!1)),h.init();this.mutator&&this.mutator.createIcon();this.updateColour();this.updateMovable();if(!this.workspace.options.readOnly&&!this.eventsInit_){Blockly.bindEvent_(this.getSvgRoot(),"mousedown",this,this.onMouseDown_);var k=this;Blockly.bindEvent_(this.getSvgRoot(),"touchstart",null,function(a){Blockly.longStart_(a,k)})}goog.isFunction(this.onchange)&&
...
Blockly.BlockSvg.prototype.setCollapsed=function(a){if(this.collapsed_!=a){for(var b=[],c=0,d;d=this.inputList[c];c++)b.push.apply(b,d.setVisible(!a));if(a){d=this.getIcons(!0);for(c=0;c<d.length;c++)d[c].setVisible(!1);c=this.toString(Blockly.COLLAPSE_CHARS);this.appendDummyInput("_TEMP_COLLAPSED_INPUT").appendField(c).init()}else this.removeInput("_TEMP_COLLAPSED_INPUT"),this.setWarningText(null);Blockly.BlockSvg.superClass_.setCollapsed.call(this,a);b.length||(b[0]=this);if(this.rendered)for(c=
0;a=b[c];c++)a.render();this.workspace.fireChangeEvent()}};Blockly.BlockSvg.prototype.tab=function(a,b){for(var c=[],d=0,e;e=this.inputList[d];d++){for(var f=0,g;g=e.fieldRow[f];f++)g instanceof Blockly.FieldTextInput&&c.push(g);e.connection&&(e=e.connection.targetBlock())&&c.push(e)}d=c.indexOf(a);-1==d&&(d=b?-1:c.length);(c=c[b?d+1:d-1])?c instanceof Blockly.Field?c.showEditor_():c.tab(null,b):(c=this.getParent())&&c.tab(this,b)};
Blockly.BlockSvg.prototype.onMouseDown_=function(a){if(!this.isInFlyout){this.workspace.markFocused();Blockly.svgResize(this.workspace);Blockly.terminateDrag_();this.select();Blockly.hideChaff();if(Blockly.isRightButton(a))this.showContextMenu_(a);else if(this.isMovable()){Blockly.removeAllRanges();Blockly.Css.setCursor(Blockly.Css.Cursor.CLOSED);this.dragStartXY_=this.getRelativeToSurfaceXY();this.workspace.startDrag(a,this.dragStartXY_.x,this.dragStartXY_.y);Blockly.dragMode_=1;Blockly.BlockSvg.onMouseUpWrapper_=
Blockly.bindEvent_(document,"mouseup",this,this.onMouseUp_);Blockly.BlockSvg.onMouseMoveWrapper_=Blockly.bindEvent_(document,"mousemove",this,this.onMouseMove_);this.draggedBubbles_=[];for(var b=this.getDescendants(),c=0,d;d=b[c];c++){d=d.getIcons(!0);for(var e=0;e<d.length;e++){var f=d[e].getIconLocation();f.bubble=d[e];this.draggedBubbles_.push(f)}}}else return;a.stopPropagation()}};
Blockly.BlockSvg.prototype.onMouseUp_=function(a){var b=this;Blockly.doCommand(function(){Blockly.terminateDrag_();if(Blockly.selected&&Blockly.highlightedConnection_)Blockly.localConnection_.connect(Blockly.highlightedConnection_),b.rendered&&(Blockly.localConnection_.isSuperior()?Blockly.highlightedConnection_:Blockly.localConnection_).sourceBlock_.connectionUiEffect(),b.workspace.trashcan&&b.workspace.trashcan.close();else if(!b.getParent()&&Blockly.selected.isDeletable()&&b.workspace.isDeleteArea(a)){var c=
b.workspace.trashcan;c&&goog.Timer.callOnce(c.close,100,c);Blockly.selected.dispose(!1,!0);Blockly.fireUiEvent(window,"resize")}Blockly.highlightedConnection_&&(Blockly.highlightedConnection_.unhighlight(),Blockly.highlightedConnection_=null);Blockly.Css.setCursor(Blockly.Css.Cursor.OPEN)})};Blockly.BlockSvg.prototype.showHelp_=function(){var a=goog.isFunction(this.helpUrl)?this.helpUrl():this.helpUrl;a&&window.open(a)};
Blockly.BlockSvg.prototype.showContextMenu_=function(a){if(!this.workspace.options.readOnly&&this.contextMenu){var b=this.buildContextMenu_();Blockly.ContextMenu.show(a,b,this.RTL);Blockly.ContextMenu.currentBlock=this}};
Blockly.BlockSvg.prototype.buildContextMenu_=function(){var a=this,b=[];if(this.workspace.options.readOnly||!this.contextMenu)return b;if(this.isDeletable()&&this.isMovable()&&!a.isInFlyout){var c={text:Blockly.Msg.DUPLICATE_BLOCK,enabled:!0,callback:function(){Blockly.duplicate_(a)}};if(this.getDescendants().length>this.workspace.remainingCapacity()||this.isUnique)c.enabled=!1;b.push(c);this.isEditable()&&!this.collapsed_&&this.workspace.options.comments&&(c={enabled:!0},this.comment?(c.text=Blockly.Msg.REMOVE_COMMENT,
c.accel=goog.events.KeyCodes.SLASH,c.callback=function(){a.setCommentText(null)}):(c.text=Blockly.Msg.ADD_COMMENT,c.accel=goog.events.KeyCodes.SLASH,c.callback=function(){a.setCommentText("")}),b.push(c));if(!this.collapsed_)for(c=1;c<this.inputList.length;c++)if(this.inputList[c-1].type!=Blockly.NEXT_STATEMENT&&this.inputList[c].type!=Blockly.NEXT_STATEMENT){var c={enabled:!0},d=this.getInputsInline();c.text=d?Blockly.Msg.EXTERNAL_INPUTS:Blockly.Msg.INLINE_INPUTS;c.callback=function(){a.setInputsInline(!d)};
b.push(c);break}this.workspace.options.collapse&&(this.collapsed_?(c={enabled:!0},c.text=Blockly.Msg.EXPAND_BLOCK,c.callback=function(){a.setCollapsed(!1)}):(c={enabled:!0},c.text=Blockly.Msg.COLLAPSE_BLOCK,c.callback=function(){a.setCollapsed(!0)}),b.push(c));this.workspace.options.disable&&(c={text:this.disabled?Blockly.Msg.ENABLE_BLOCK:Blockly.Msg.DISABLE_BLOCK,enabled:!this.getInheritedDisabled(),callback:function(){a.setDisabled(!a.disabled)}},b.push(c));var c=this.getDescendants().length,e=
this.getNextBlock();e&&(c-=e.getDescendants().length);c={text:1==c?Blockly.Msg.DELETE_BLOCK:Blockly.Msg.DELETE_X_BLOCKS.replace("%1",String(c)),enabled:!0,callback:function(){a.dispose(!0,!0)}};b.push(c)}c={enabled:!(goog.isFunction(this.helpUrl)?!this.helpUrl():!this.helpUrl)};c.text=Blockly.Msg.HELP;c.callback=function(){a.showHelp_()};b.push(c);this.customContextMenu&&!a.isInFlyout&&this.customContextMenu(b);return b};
Blockly.BlockSvg.prototype.moveConnections_=function(a,b){if(this.rendered){for(var c=this.getConnections_(!1),d=0;d<c.length;d++)c[d].moveBy(a,b);c=this.getIcons(!0);for(d=0;d<c.length;d++)c[d].computeIconLocation();for(d=0;d<this.childBlocks_.length;d++)this.childBlocks_[d].moveConnections_(a,b)}};Blockly.BlockSvg.prototype.setDragging_=function(a){a?this.addDragging():this.removeDragging();for(var b=0;b<this.childBlocks_.length;b++)this.childBlocks_[b].setDragging_(a)};
Blockly.BlockSvg.prototype.moveByKey=function(a,b){var c=goog.style.getBoundingClientRect_(this.getSvgRoot()),d=new MouseEvent("mousedown",{clientX:c.x,clientY:c.y});this.onMouseDown_(d);d=new MouseEvent("mousemove",{clientX:c.x+a,clientY:c.y+b});this.onMouseMove_(d);this.onMouseMove_(d);d=new MouseEvent("mouseup",{clientX:c.x+a,clientY:c.y+b});this.workspace.deleteAreaTrash_=null;this.workspace.deleteAreaToolbox_=null;c=this.bumpNeighbours_;this.bumpNeighbours_=function(){};this.onMouseUp_(d);this.bumpNeighbours_=
c};
Blockly.BlockSvg.prototype.onMouseMove_=function(a){var b=this,c=this.workspace;Blockly.doCommand(function(){if(!("mousemove"==a.type&&1>=a.clientX&&0==a.clientY&&0==a.button)){Blockly.removeAllRanges();var d=b.getRelativeToSurfaceXY(),e=c.moveDrag(a),f=b.getSvgRoot();1==Blockly.dragMode_&&goog.math.Coordinate.distance(d,e)*c.scale>Blockly.DRAG_RADIUS&&(Blockly.dragMode_=2,Blockly.longStop_(),f.translate_="",f.skew_="",b.parentBlock_&&(b.setParent(null),b.disconnectUiEffect()),b.setDragging_(!0),c.recordDeleteAreas());
if(2==Blockly.dragMode_){var g=d.x-b.dragStartXY_.x,d=d.y-b.dragStartXY_.y;f.translate_="translate("+e.x+","+e.y+")";f.setAttribute("transform",f.translate_+f.skew_);for(e=0;e<b.draggedBubbles_.length;e++)f=b.draggedBubbles_[e],f.bubble.setIconLocation(f.x+g,f.y+d);for(var f=b.getConnections_(!1),h=null,k=null,l=Blockly.SNAP_RADIUS,e=0;e<f.length;e++){var n=f[e],m=n.closest(l,g,d);m.connection&&(h=m.connection,k=n,l=m.radius)}Blockly.highlightedConnection_&&Blockly.highlightedConnection_!=h&&(Blockly.highlightedConnection_.unhighlight(),
Blockly.highlightedConnection_=null,Blockly.localConnection_=null);h&&h!=Blockly.highlightedConnection_&&(h.highlight(),Blockly.highlightedConnection_=h,Blockly.localConnection_=k);b.isDeletable()&&c.isDeleteArea(a)}}a.stopPropagation()})};Blockly.BlockSvg.prototype.updateMovable=function(){this.isMovable()?Blockly.addClass_(this.svgGroup_,"blocklyDraggable"):Blockly.removeClass_(this.svgGroup_,"blocklyDraggable")};
Blockly.BlockSvg.prototype.setMovable=function(a){Blockly.BlockSvg.superClass_.setMovable.call(this,a);this.updateMovable()};Blockly.BlockSvg.prototype.setEditable=function(a){Blockly.BlockSvg.superClass_.setEditable.call(this,a);if(this.rendered){a=this.getIcons(!0);for(var b=0;b<a.length;b++)a[b].updateEditable()}};Blockly.BlockSvg.prototype.setShadow=function(a){Blockly.BlockSvg.superClass_.setShadow.call(this,a);this.updateColour()};Blockly.BlockSvg.prototype.getSvgRoot=function(){return this.svgGroup_};
...
Blockly.BlockSvg.prototype.updateColour=function(){if(!this.disabled){var a=Blockly.makeColour(this.getColour()),b=goog.color.hexToRgb(a);if(this.isShadow())b=goog.color.lighten(b,.6),a=goog.color.rgbArrayToHex(b),this.svgPathLight_.style.display="none",this.svgPathDark_.setAttribute("fill",a);else{this.svgPathLight_.style.display="";var c=goog.color.rgbArrayToHex(goog.color.lighten(b,.3)),b=goog.color.rgbArrayToHex(goog.color.darken(b,.2));this.svgPathLight_.setAttribute("stroke",c);this.svgPathDark_.setAttribute("fill",
b)}this.svgPath_.setAttribute("fill",a);a=this.getIcons(!0);for(c=0;c<a.length;c++)a[c].updateColour();for(a=0;c=this.inputList[a];a++)for(var b=0,d;d=c.fieldRow[b];b++)d.setText(null)}};
Blockly.BlockSvg.prototype.updateDisabled=function(){var a=Blockly.hasClass_(this.svgGroup_,"blocklyDisabled");this.disabled||this.getInheritedDisabled()?a||(Blockly.addClass_(this.svgGroup_,"blocklyDisabled"),this.svgPath_.setAttribute("stroke","red"),this.svgPath_.setAttribute("stroke-width","2"),this.svgPath_.setAttribute("stroke-opacity","stroke-opacity:1.0"),this.svgPath_.setAttribute("stroke-dasharray","10, 5")):a&&(Blockly.removeClass_(this.svgGroup_,"blocklyDisabled"),this.svgPath_.removeAttribute("stroke",
"red"),this.svgPath_.removeAttribute("stroke-width","2"),this.svgPath_.removeAttribute("stroke-opacity","stroke-opacity:1.0"),this.svgPath_.removeAttribute("stroke-dasharray","10, 5"),this.updateColour());for(var a=this.getChildren(),b=0,c;c=a[b];b++)c.updateDisabled()};Blockly.BlockSvg.prototype.getCommentText=function(){return this.comment?this.comment.getText().replace(/\s+$/,"").replace(/ +\n/g,"\n"):""};
...
(this.render(),this.bumpNeighbours_())}};Blockly.BlockSvg.prototype.setMutator=function(a){this.mutator&&this.mutator!==a&&this.mutator.dispose();a&&(a.block_=this,this.mutator=a,this.rendered&&a.createIcon())};Blockly.BlockSvg.prototype.setDisabled=function(a){this.disabled!=a&&(Blockly.BlockSvg.superClass_.setDisabled.call(this,a),this.rendered&&this.updateDisabled(),this.workspace.fireChangeEvent())};
...
Blockly.BlockSvg.prototype.render=function(a){Blockly.Field.startCache();this.rendered=!0;var b=Blockly.BlockSvg.SEP_SPACE_X;this.RTL&&(b=-b);for(var c=this.getIcons(!1),d=0;d<c.length;d++)b=c[d].renderIcon(b);b+=this.RTL?Blockly.BlockSvg.SEP_SPACE_X:-Blockly.BlockSvg.SEP_SPACE_X;d=this.renderCompute_(b);this.renderDraw_(b,d);!1!==a&&((a=this.getParent())?a.render(!0):Blockly.fireUiEvent(window,"resize"));a=this.getIcons(!0);if(a.length>c.length)for(d=0;d<a.length;d++)goog.array.contains(c,a[d])||
a[d].computeIconLocation();Blockly.Field.stopCache();Blockly.Realtime.blockChanged(this)};
...
Blockly.NEXT_STATEMENT?Blockly.BlockSvg.INLINE:m.type,p.height=0,c.push(p));p.push(m);m.renderHeight=Blockly.BlockSvg.MIN_BLOCK_Y;m.renderWidth=l&&m.type==Blockly.INPUT_VALUE?Blockly.BlockSvg.TAB_WIDTH+1.25*Blockly.BlockSvg.SEP_SPACE_X:0;if(m.connection&&m.connection.targetConnection){var q=m.connection.targetBlock().getHeightWidth();m.renderHeight=Math.max(m.renderHeight,q.height);m.renderWidth=Math.max(m.renderWidth,q.width)}l||n!=b.length-1?!l&&m.type==Blockly.INPUT_VALUE&&b[n+1]&&b[n+1].type==
Blockly.NEXT_STATEMENT&&m.renderHeight--:m.renderHeight--;p.height=Math.max(p.height,m.renderHeight);m.fieldWidth=0;1==c.length&&(m.fieldWidth+=this.RTL?-a:a);for(var q=!1,r=0,u;u=m.fieldRow[r];r++){0!=r&&(m.fieldWidth+=Blockly.BlockSvg.SEP_SPACE_X);var t=u.getSize();u.renderWidth=t.width;u.renderSep=q&&u.EDITABLE?Blockly.BlockSvg.SEP_SPACE_X:0;m.fieldWidth+=u.renderWidth+u.renderSep;p.height=Math.max(p.height,t.height);q=u.EDITABLE}p.type!=Blockly.BlockSvg.INLINE&&(p.type==Blockly.NEXT_STATEMENT?
...
Blockly.BlockSvg.prototype.renderDrawRight_=function(a,b,c,d,e,f,g){for(var h,k=0,l,n,m=0,p;p=f[m];m++){h=Blockly.BlockSvg.SEP_SPACE_X;0==m&&(h+=this.RTL?-g:g);b.push("M",f.rightEdge-.5+","+(k+.5));if(this.isCollapsed()){var q=p[0];l=k;this.renderFields_(q.fieldRow,h,l);a.push(Blockly.BlockSvg.JAGGED_TEETH);b.push("h 8");q=p.height-Blockly.BlockSvg.JAGGED_TEETH_HEIGHT;a.push("v",q);this.RTL&&(b.push("v 3.9 l 7.2,3.4 m -14.5,8.9 l 7.3,3.5"),b.push("v",q-.7));this.width+=Blockly.BlockSvg.JAGGED_TEETH_WIDTH}else if(p.type==
Blockly.BlockSvg.INLINE){for(var r=0;q=p[r];r++)l=k,p.thicker&&(l+=Blockly.BlockSvg.INLINE_PADDING_Y),h=this.renderFields_(q.fieldRow,h,l),q.type!=Blockly.DUMMY_INPUT&&(h+=q.renderWidth+Blockly.BlockSvg.SEP_SPACE_X),q.type==Blockly.INPUT_VALUE&&(c.push("M",h-Blockly.BlockSvg.SEP_SPACE_X+","+(k+Blockly.BlockSvg.INLINE_PADDING_Y)),c.push("h",Blockly.BlockSvg.TAB_WIDTH-2-q.renderWidth),c.push(Blockly.BlockSvg.TAB_PATH_DOWN),c.push("v",q.renderHeight+1-Blockly.BlockSvg.TAB_HEIGHT),c.push("h",q.renderWidth+
2-Blockly.BlockSvg.TAB_WIDTH),c.push("z"),this.RTL?(d.push("M",h-Blockly.BlockSvg.SEP_SPACE_X-2.5+Blockly.BlockSvg.TAB_WIDTH-q.renderWidth+","+(k+Blockly.BlockSvg.INLINE_PADDING_Y+.5)),d.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL),d.push("v",q.renderHeight-Blockly.BlockSvg.TAB_HEIGHT+2.5),d.push("h",q.renderWidth-Blockly.BlockSvg.TAB_WIDTH+2)):(d.push("M",h-Blockly.BlockSvg.SEP_SPACE_X+.5+","+(k+Blockly.BlockSvg.INLINE_PADDING_Y+.5)),d.push("v",q.renderHeight+1),d.push("h",Blockly.BlockSvg.TAB_WIDTH-
2-q.renderWidth),d.push("M",h-q.renderWidth-Blockly.BlockSvg.SEP_SPACE_X+.9+","+(k+Blockly.BlockSvg.INLINE_PADDING_Y+Blockly.BlockSvg.TAB_HEIGHT-.7)),d.push("l",.46*Blockly.BlockSvg.TAB_WIDTH+",-2.1")),l=this.RTL?e.x-h-Blockly.BlockSvg.TAB_WIDTH+Blockly.BlockSvg.SEP_SPACE_X+q.renderWidth+1:e.x+h+Blockly.BlockSvg.TAB_WIDTH-Blockly.BlockSvg.SEP_SPACE_X-q.renderWidth-1,n=e.y+k+Blockly.BlockSvg.INLINE_PADDING_Y+1,q.connection.moveTo(l,n),q.connection.targetConnection&&q.connection.tighten_());h=Math.max(h,
f.rightEdge);this.width=Math.max(this.width,h);a.push("H",h);b.push("H",h-.5);a.push("v",p.height);this.RTL&&b.push("v",p.height-1)}else p.type==Blockly.INPUT_VALUE?(q=p[0],l=k,q.align!=Blockly.ALIGN_LEFT&&(r=f.rightEdge-q.fieldWidth-Blockly.BlockSvg.TAB_WIDTH-2*Blockly.BlockSvg.SEP_SPACE_X,q.align==Blockly.ALIGN_RIGHT?h+=r:q.align==Blockly.ALIGN_CENTRE&&(h+=r/2)),this.renderFields_(q.fieldRow,h,l),a.push(Blockly.BlockSvg.TAB_PATH_DOWN),r=p.height-Blockly.BlockSvg.TAB_HEIGHT,a.push("v",r),this.RTL?
(b.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL),b.push("v",r+.5)):(b.push("M",f.rightEdge-5+","+(k+Blockly.BlockSvg.TAB_HEIGHT-.7)),b.push("l",.46*Blockly.BlockSvg.TAB_WIDTH+",-2.1")),l=e.x+(this.RTL?-f.rightEdge-1:f.rightEdge+1),n=e.y+k,q.connection.moveTo(l,n),q.connection.targetConnection&&(q.connection.tighten_(),this.width=Math.max(this.width,f.rightEdge+q.connection.targetBlock().getHeightWidth().width-Blockly.BlockSvg.TAB_WIDTH+1))):p.type==Blockly.DUMMY_INPUT?(q=p[0],l=k,q.align!=Blockly.ALIGN_LEFT&&
(r=f.rightEdge-q.fieldWidth-2*Blockly.BlockSvg.SEP_SPACE_X,f.hasValue&&(r-=Blockly.BlockSvg.TAB_WIDTH),q.align==Blockly.ALIGN_RIGHT?h+=r:q.align==Blockly.ALIGN_CENTRE&&(h+=r/2)),this.renderFields_(q.fieldRow,h,l),a.push("v",p.height),this.RTL&&b.push("v",p.height-1)):p.type==Blockly.NEXT_STATEMENT&&(q=p[0],0==m&&(a.push("v",Blockly.BlockSvg.SEP_SPACE_Y),this.RTL&&b.push("v",Blockly.BlockSvg.SEP_SPACE_Y-1),k+=Blockly.BlockSvg.SEP_SPACE_Y),l=k,q.align!=Blockly.ALIGN_LEFT&&(r=f.statementEdge-q.fieldWidth-
2*Blockly.BlockSvg.SEP_SPACE_X,q.align==Blockly.ALIGN_RIGHT?h+=r:q.align==Blockly.ALIGN_CENTRE&&(h+=r/2)),this.renderFields_(q.fieldRow,h,l),h=f.statementEdge+Blockly.BlockSvg.NOTCH_WIDTH,a.push("H",h),a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER),a.push("v",p.height-2*Blockly.BlockSvg.CORNER_RADIUS),a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER),a.push("H",f.rightEdge),this.RTL?(b.push("M",h-Blockly.BlockSvg.NOTCH_WIDTH+Blockly.BlockSvg.DISTANCE_45_OUTSIDE+","+(k+Blockly.BlockSvg.DISTANCE_45_OUTSIDE)),
b.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL),b.push("v",p.height-2*Blockly.BlockSvg.CORNER_RADIUS),b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL)):(b.push("M",h-Blockly.BlockSvg.NOTCH_WIDTH+Blockly.BlockSvg.DISTANCE_45_OUTSIDE+","+(k+p.height-Blockly.BlockSvg.DISTANCE_45_OUTSIDE)),b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR)),b.push("H",f.rightEdge-.5),l=e.x+(this.RTL?-h:h+1),n=e.y+k+1,q.connection.moveTo(l,n),q.connection.targetConnection&&(q.connection.tighten_(),
this.width=Math.max(this.width,f.statementEdge+q.connection.targetBlock().getHeightWidth().width)),m==f.length-1||f[m+1].type==Blockly.NEXT_STATEMENT)&&(a.push("v",Blockly.BlockSvg.SEP_SPACE_Y),this.RTL&&b.push("v",Blockly.BlockSvg.SEP_SPACE_Y-1),k+=Blockly.BlockSvg.SEP_SPACE_Y);k+=p.height}f.length||(k=Blockly.BlockSvg.MIN_BLOCK_Y,a.push("V",k),this.RTL&&b.push("V",k-1));return k};
...
",-0.5 q "+-.19*Blockly.BlockSvg.TAB_WIDTH+",-5.5 0,-11"),b.push("m",.92*Blockly.BlockSvg.TAB_WIDTH+",1 V 0.5 H 1")),this.width+=Blockly.BlockSvg.TAB_WIDTH):this.RTL||(this.squareTopLeftCorner_?b.push("V",.5):b.push("V",Blockly.BlockSvg.CORNER_RADIUS));a.push("z")};Blockly.FieldTextInput=function(a,b){Blockly.FieldTextInput.superClass_.constructor.call(this,a);this.setChangeHandler(b)};goog.inherits(Blockly.FieldTextInput,Blockly.Field);Blockly.FieldTextInput.FONTSIZE=11;Blockly.FieldTextInput.prototype.CURSOR="text";Blockly.FieldTextInput.prototype.spellcheck_=!0;Blockly.FieldTextInput.prototype.dispose=function(){Blockly.WidgetDiv.hideIfOwner(this);Blockly.FieldTextInput.superClass_.dispose.call(this)};
...
b=this.sourceBlock_.workspace.getCanvas();a.onWorkspaceChangeWrapper_=Blockly.bindEvent_(b,"blocklyWorkspaceChange",this,this.resizeEditor_)}};Blockly.FieldTextInput.prototype.onHtmlInputKeyDown_=function(a){var b=Blockly.FieldTextInput.htmlInput_;a.keyCode==goog.events.KeyCodes.ENTER?Blockly.WidgetDiv.hide():a.keyCode==goog.events.KeyCodes.ESC&&(this.setText(b.defaultValue),Blockly.WidgetDiv.hide())};
Blockly.FieldTextInput.prototype.onHtmlInputChange_=function(a){var b=Blockly.FieldTextInput.htmlInput_;a.keyCode!=goog.events.KeyCodes.ESC&&(a=b.value,a!==b.oldValue_?(this.sourceBlock_.setShadow(!1),b.oldValue_=a,this.setText(a),this.validate_()):goog.userAgent.WEBKIT&&this.sourceBlock_.render())};
...
void 0!==b&&(a=b)}null!==a&&(g.sourceBlock_.setShadow(!1),g.setValue(a))})};Blockly.FieldColour.widgetDispose_=function(){Blockly.FieldColour.changeEventKey_&&goog.events.unlistenByKey(Blockly.FieldColour.changeEventKey_)};Blockly.FieldTextArea=function(a,b){Blockly.FieldTextArea.superClass_.constructor.call(this,a,b)};goog.inherits(Blockly.FieldTextArea,Blockly.FieldTextInput);
Blockly.FieldTextArea.prototype.updateTextNode_=function(){if(this.textElement_){var a=this.text_;goog.dom.removeChildren(this.textElement_);a=a.replace(/ /g,Blockly.Field.NBSP);this.sourceBlock_.RTL&&a&&(a+="\u200f");a||(a=Blockly.Field.NBSP);for(var a=a.split("\n"),b="0em",c=0;c<a.length;c++){var d=Blockly.createSvgElement("tspan",{dy:b,x:0},this.textElement_),b="1em",e=document.createTextNode(a[c]);d.appendChild(e)}this.size_.width=0}};
Blockly.FieldTextArea.prototype.render_=function(){this.size_.width=this.textElement_.getBBox().width+5;this.size_.height=20*(this.text_.split(/\n/).length||1)+(Blockly.BlockSvg.SEP_SPACE_Y+5);this.minWidth_&&this.size_.width<this.minWidth_&&(this.size_.width=this.minWidth_);this.borderRect_&&(this.borderRect_.setAttribute("width",this.size_.width+Blockly.BlockSvg.SEP_SPACE_X),this.borderRect_.setAttribute("height",this.size_.height-(Blockly.BlockSvg.SEP_SPACE_Y+5)))};
Blockly.FieldTextArea.prototype.showEditor_=function(a){var b=a||!1;if(!b&&(goog.userAgent.MOBILE||goog.userAgent.ANDROID||goog.userAgent.IPAD))a=window.prompt(Blockly.Msg.CHANGE_VALUE_TITLE,this.text_),this.changeHandler_&&(b=this.changeHandler_(a),void 0!==b&&(a=b)),null!==a&&this.setText(a);else{Blockly.WidgetDiv.show(this,this.sourceBlock_.RTL,this.widgetDispose_());var c=Blockly.WidgetDiv.DIV;a=goog.dom.createDom("textarea","blocklyHtmlInput");Blockly.FieldTextInput.htmlInput_=a;a.style.resize=
"none";a.style["line-height"]="20px";a.style.height="100%";c.appendChild(a);a.value=a.defaultValue=this.text_;a.oldValue_=null;this.validate_();this.resizeEditor_();b||(a.focus(),a.select());a.onKeyDownWrapper_=Blockly.bindEvent_(a,"keydown",this,this.onHtmlInputKeyDown_);a.onKeyUpWrapper_=Blockly.bindEvent_(a,"keyup",this,this.onHtmlInputChange_);a.onKeyPressWrapper_=Blockly.bindEvent_(a,"keypress",this,this.onHtmlInputChange_);b=this.sourceBlock_.workspace.getCanvas();a.onWorkspaceChangeWrapper_=
Blockly.bindEvent_(b,"blocklyWorkspaceChange",this,this.resizeEditor_)}};Blockly.FieldTextInput.prototype.onHtmlInputKeyDown_=function(a){var b=Blockly.FieldTextInput.htmlInput_;a.keyCode==goog.events.KeyCodes.ESC&&(this.setText(b.defaultValue),Blockly.WidgetDiv.hide())};
Blockly.FieldTextArea.prototype.onHtmlInputChange_=function(a){Blockly.FieldTextInput.prototype.onHtmlInputChange_.call(this,a);var b=Blockly.FieldTextInput.htmlInput_;a.keyCode==goog.events.KeyCodes.ESC?(this.setText(b.defaultValue),Blockly.WidgetDiv.hide()):(Blockly.FieldTextInput.prototype.onHtmlInputChange_.call(this,a),this.resizeEditor_())};
Blockly.FieldTextArea.prototype.resizeEditor_=function(){var a=Blockly.WidgetDiv.DIV,b=this.fieldGroup_.getBBox();a.style.width=b.width+"px";a.style.height=b.height+"px";b=this.getAbsoluteXY_();if(this.RTL){var c=this.borderRect_.getBBox();b.x+=c.width;b.x-=a.offsetWidth}b.y+=1;goog.userAgent.WEBKIT&&(b.y-=3);a.style.left=b.x+"px";a.style.top=b.y+"px"};Blockly.Variables={};Blockly.Variables.NAME_TYPE="VARIABLE";Blockly.Variables.allVariables=function(a){var b;if(a.getDescendants)b=a.getDescendants();else if(a.getAllBlocks)b=a.getAllBlocks();else throw"Not Block or Workspace: "+a;a=Object.create(null);for(var c=0;c<b.length;c++)if(b[c].getVars)for(var d=b[c].getVars(),e=0;e<d.length;e++){var f=d[e];f&&(a[f.toLowerCase()]=f)}b=[];for(var g in a)b.push(a[g]);return b};
Blockly.Variables.Intersection=function(a,b){var c=function(a){for(var b={},c=0;c<a.length;c++){var d=Blockly.VariableTypeEquivalence[a[c]];d||(d=[a[c]]);for(var e=0;e<d.length;e++)for(var f=d[e].split(":"),p=b;0<f.length;){var q=f.shift();"object"===typeof p[q]?p=p[q]:f.length?(p[q]={},p=p[q]):p[q]=1}}return b},d=function(a,b){var c={},e=!1,f;for(f in a)a.hasOwnProperty(f)&&b.hasOwnProperty(f)&&(1===a[f]?c[f]=b[f]:1===b[f]?c[f]=a[f]:((e=d(a[f],b[f]))||(e={Var:1}),c[f]=e),e=!0);e||(c=null);return c},
e=function(a){var b=[];if(a)for(var c in a)if(a.hasOwnProperty(c))if(1===a[c])b.push(c);else for(var d=e(a[c]),f=0;f<d.length;f++)b.push(c+":"+d[f]);return b},f=c(a),c=c(b);return e(d(f,c))};Blockly.Variables.resolveTypes=function(a){var b="";0===a.length?b="Number":(1!==a.length&&-1===goog.array.indexOf(a,"Object")&&console.log("Multiple types found for "+a),b=a[0]);return b};
Blockly.Variables.allVariablesTypes=function(a){var b;if(a.getDescendants)b=a.getDescendants();else if(a.getAllBlocks)b=a.getAllBlocks();else throw"Not Block or Workspace: "+a;a=Object.create(null);Object.create(null);for(var c=0;c<b.length;c++){var d=b[c].getVarsTypes;if(d){var d=d.call(b[c]),e;for(e in d)if(d.hasOwnProperty(e))if("undefined"===typeof a[e])a[e]=d[e];else{var f=Blockly.Variables.Intersection(a[e],d[e]);goog.array.isEmpty(f)&&(f=["Var"]);console.log("Block:"+b[c].type+"."+b[c].id+
" For: "+e+" was:"+a[e]+" got:"+d[e]+" result="+f);a[e]=f}}}b=Object.create(null);for(e in a)b[e]=this.resolveTypes(a[e]);return b};Blockly.Variables.renameVariable=function(a,b,c){c=c.getAllBlocks();for(var d=0;d<c.length;d++)c[d].renameVar&&c[d].renameVar(a,b)};
...
Blockly.Variables.generateUniqueName=function(a){a=Blockly.Variables.allVariables(a);var b="";if(a.length)for(var c=1,d=0,e="ijkmnopqrstuvwxyzabcdefgh".charAt(d);!b;){for(var f=!1,g=0;g<a.length;g++)if(a[g].toLowerCase()==e){f=!0;break}f?(d++,25==d&&(d=0,c++),e="ijkmnopqrstuvwxyzabcdefgh".charAt(d),1<c&&(e+=c)):b=e}else b="i";return b};
Blockly.Variables.getLocalContext=function(a,b){do{if(a.getProcedureDef){var c=a.getProcedureDef.call(a),d=c[1];if(null===b)return c[0]+".";for(var e=0;e<d.length;e++)if(d[e].name===b)return c[0]+".";break}else"initialize_variable"===a.type&&a.getFieldValue("VAR")===b&&(b=null);a=a.getParent()}while(a);return null};Blockly.FieldVariable=function(a,b){Blockly.FieldVariable.superClass_.constructor.call(this,Blockly.FieldVariable.dropdownCreate,null);this.setChangeHandler(b);this.setValue(a||"")};goog.inherits(Blockly.FieldVariable,Blockly.FieldDropdown);
Blockly.FieldVariable.prototype.setChangeHandler=function(a){Blockly.FieldVariable.superClass_.setChangeHandler.call(this,a?function(b){var c=a.call(this,b);if(null===c)var d=c;else void 0===c&&(c=b),d=Blockly.FieldVariable.dropdownChange.call(this,c),void 0!==d&&(d=c);return d===b?void 0:d}:Blockly.FieldVariable.dropdownChange)};
...
""))?(Blockly.Variables.renameVariable(a,a,c),a):null};Blockly.Generator=function(a){this.name_=a;this.FUNCTION_NAME_PLACEHOLDER_REGEXP_=new RegExp(this.FUNCTION_NAME_PLACEHOLDER_,"g")};Blockly.Generator.NAME_TYPE="generated_function";Blockly.Generator.prototype.INFINITE_LOOP_TRAP=null;Blockly.Generator.prototype.STATEMENT_PREFIX=null;Blockly.Generator.prototype.STATEMENT_STASH="";Blockly.Generator.prototype.STATEMENT_STASH_PEND="";
Blockly.Generator.prototype.workspaceToCode=function(a,b){a||(console.warn("No workspace specified in workspaceToCode call.  Guessing."),a=Blockly.getMainWorkspace());var c=[];this.init(a);for(var d=a.getTopBlocks(!0),e=0,f;f=d[e];e++){var g=this.blockToCode(f,b),h=this.getStatementStash();""!==h&&c.push(h);goog.isArray(g)&&(g=g[0]);g&&(f.outputConnection&&this.scrubNakedValue&&(g=this.scrubNakedValue(g)),c.push(g))}c=c.join("\n");c=this.finish(c);c=c.replace(/^\s+\n/,"");c=c.replace(/\n\s+$/,"\n");
...
Blockly.Generator.prototype.blockToCode=function(a,b,c){if(!a)return"";if(a.disabled||a.getInheritedDisabled())return this.blockToCode(a.getNextBlock(),b,c);var d=this[a.type];goog.asserts.assertFunction(d,'Language "%s" does not know how to generate code for block type "%s".',this.name_,a.type);var d=d.call(a,a,b),e="";c||(e=this.getStatementStash());if(goog.isArray(d))return[this.scrub_(a,e+d[0],b),d[1]];if(goog.isString(d))return this.STATEMENT_PREFIX&&(d=this.STATEMENT_PREFIX.replace(/%1/g,"'"+
a.id+"'")+d),this.scrub_(a,e+d,b);if(null===d)return e;goog.asserts.fail("Invalid code generated: %s",d)};
Blockly.Generator.prototype.valueToCode=function(a,b,c,d){isNaN(c)&&goog.asserts.fail('Expecting valid order from block "%s".',a.type);a=a.getInputTargetBlock(b);if(!a)return"";b=this.blockToCode(a,d,!0);if(""===b)return"";goog.asserts.assertArray(b,'Expecting tuple from value block "%s".',a.type);d=b[0];b=b[1];isNaN(b)&&goog.asserts.fail('Expecting valid order from value block "%s".',a.type);d&&c<=b&&(c!=b||0!=c&&99!=c)&&(d="("+d+")");return d};
Blockly.Generator.prototype.statementToCode=function(a,b,c){a=a.getInputTargetBlock(b);c=this.blockToCode(a,c);goog.asserts.assertString(c,'Expecting code from statement block "%s".',a&&a.type);c&&(c=this.prefixLines(c,this.INDENT));return c};Blockly.Generator.prototype.addLoopTrap=function(a,b){this.INFINITE_LOOP_TRAP&&(a=this.INFINITE_LOOP_TRAP.replace(/%1/g,"'"+b+"'")+a);this.STATEMENT_PREFIX&&(a+=this.prefixLines(this.STATEMENT_PREFIX.replace(/%1/g,"'"+b+"'"),this.INDENT));return a};
...
Blockly.Generator.prototype.getStatementStash=function(){var a=this.STATEMENT_STASH;this.STATEMENT_STASH="";return a};Blockly.Generator.prototype.stashStatement=function(a,b){null!=b&&(this.STATEMENT_STASH_PEND=b);a&&(""!=this.STATEMENT_STASH_PEND&&(this.STATEMENT_STASH+=this.STATEMENT_STASH_PEND,this.STATEMENT_STASH_PEND=""),this.STATEMENT_STASH+=a)};Blockly.Names=function(a,b){this.variablePrefix_=b||"";this.reservedDict_=Object.create(null);if(a)for(var c=a.split(","),d=0;d<c.length;d++)this.reservedDict_[c[d]]=!0;this.reset()};Blockly.Names.prototype.reset=function(){this.db_=Object.create(null);this.dbReverse_=Object.create(null)};
...
Blockly.Realtime.addTopBlock=function(a){-1==Blockly.Realtime.topBlocks_.indexOf(a)&&Blockly.Realtime.topBlocks_.push(a)};Blockly.Realtime.removeTopBlock=function(a){Blockly.Realtime.topBlocks_.removeValue(a)};Blockly.Realtime.obtainBlock=function(a,b){return Blockly.Realtime.model_.create(Blockly.BlockSvg,a,b)};
Blockly.Realtime.getBlockById=function(a){var b=Blockly.Realtime.blocksMap_.get(a);b?console.log("Realtime.getBlockById:"+b.id+" for id="+a):console.log("Realtime.getBlockById: NULL for id="+a);return b};
Blockly.Realtime.logEvent_=function(a,b){var c="";a.isLocal&&(c="<LOCAL>");console.log("*** "+b+" Object event:"+c);console.log("  id: "+a.target.id);console.log("  type: "+a.type);if(c=a.events)for(var d=c.length,e=0;e<d;e++){var f=c[e];console.log("  child event:");console.log("    id: "+f.target.id);console.log("    type: "+f.type);console.log("  User ID: "+f.userId);console.log("  Session ID: "+f.sessionId);console.log(" Local event: "+f.isLocal)}};
Blockly.Realtime.onObjectChange_=function(a){var b=a.events;Blockly.Realtime.logEvent_(a,"onObjectChange_");a=a.events.length;for(var c=0;c<a;c++){var d=b[c];if(!d.isLocal||Blockly.Realtime.withinUndo_){var e=d.target;"value_changed"==d.type&&("xmlDom"==d.property?Blockly.Realtime.doWithinSync_(function(){Blockly.Realtime.placeBlockOnWorkspace_(e,!1);Blockly.Realtime.moveBlock_(e)}):"relativeX"!=d.property&&"relativeY"!=d.property||Blockly.Realtime.doWithinSync_(function(){e.svgGroup_||Blockly.Realtime.placeBlockOnWorkspace_(e,
!1);Blockly.Realtime.moveBlock_(e)}))}}};Blockly.Realtime.onBlocksMapChange_=function(a){Blockly.Realtime.logEvent_(a,"onBlocksMapChange_");if(!a.isLocal||Blockly.Realtime.withinUndo_){var b=a.newValue;b?Blockly.Realtime.placeBlockOnWorkspace_(b,!a.oldValue):(b=a.oldValue,Blockly.Realtime.deleteBlock(b))}};Blockly.Realtime.doWithinSync_=function(a){if(Blockly.Realtime.withinSync)a();else try{Blockly.Realtime.withinSync=!0,a()}finally{Blockly.Realtime.withinSync=!1}};
...
Blockly.Realtime.moveBlock_=function(a){if(!isNaN(a.relativeX)&&!isNaN(a.relativeY)){var b=Blockly.svgSize(Blockly.mainWorkspace.options.svg).width,c=a.getRelativeToSurfaceXY(),d=a.relativeX-c.x;a.moveBy(Blockly.RTL?b-d:d,a.relativeY-c.y)}};Blockly.Realtime.deleteBlock=function(a){Blockly.Realtime.doWithinSync_(function(){a.dispose(!0,!0,!0)})};
Blockly.Realtime.loadBlocks_=function(){for(var a=Blockly.Realtime.topBlocks_,b=0;b<a.length;b++){var c=a.get(b);Blockly.Realtime.placeBlockOnWorkspace_(c,!0)}};
...
Blockly.Realtime.registerTypes_=function(){var a=gapi.drive.realtime.custom;a.registerType(Blockly.BlockSvg,"BlockSvg");Blockly.BlockSvg.prototype.id=a.collaborativeField("id");Blockly.BlockSvg.prototype.xmlDom=a.collaborativeField("xmlDom");Blockly.BlockSvg.prototype.relativeX=a.collaborativeField("relativeX");Blockly.BlockSvg.prototype.relativeY=a.collaborativeField("relativeY");a.setInitializer(Blockly.BlockSvg,Blockly.Block.prototype.initialize)};
Blockly.Realtime.REAUTH_INTERVAL_IN_MILLISECONDS_=18E5;Blockly.Realtime.afterAuth_=function(){setTimeout(function(){Blockly.Realtime.realtimeLoader_.authorizer.authorize(Blockly.Realtime.afterAuth_)},Blockly.Realtime.REAUTH_INTERVAL_IN_MILLISECONDS_)};
...
Blockly.Realtime.startRealtime=function(a,b,c,d){Blockly.Realtime.parseOptions_(c);Blockly.Realtime.enabled_=!0;Blockly.Realtime.addAuthUi_(b,d);Blockly.Realtime.initUi_=function(){a();if(Blockly.Realtime.chatBoxElementId_){var b=Blockly.Realtime.model_.getRoot().get(Blockly.Realtime.chatBoxElementId_),c=document.getElementById(Blockly.Realtime.chatBoxElementId_);gapi.drive.realtime.databinding.bindString(b,c);c.disabled=!1}};Blockly.Realtime.realtimeLoader_=new rtclient.RealtimeLoader(Blockly.Realtime.rtclientOptions_);
Blockly.Realtime.realtimeLoader_.start()};
Blockly.Realtime.addAuthUi_=function(a,b){a.style.background="url("+b+Blockly.Realtime.PROGRESS_URL_+") no-repeat center center";var c=goog.style.getBounds(a),d=goog.dom.createDom("div");d.id=Blockly.Realtime.rtclientOptions_.authDivElementId;var e=goog.dom.createDom("p",null,Blockly.Msg.AUTH);d.appendChild(e);e=goog.dom.createDom("button",null,"Authorize");e.id=Blockly.Realtime.rtclientOptions_.authButtonElementId;d.appendChild(e);a.appendChild(d);d.style.display="none";d.style.position="relative";
d.style.textAlign="center";d.style.border="1px solid";d.style.backgroundColor="#f6f9ff";d.style.borderRadius="15px";d.style.boxShadow="10px 10px 5px #888";d.style.width=c.width/3+"px";e=goog.style.getBounds(d);d.style.left=(c.width-e.width)/3+"px";d.style.top=(c.height-e.height)/4+"px";return d};
...
Blockly.Realtime.onCollaboratorJoined_=function(a){Blockly.Realtime.updateCollabUi_()};Blockly.Realtime.onCollaboratorLeft_=function(a){Blockly.Realtime.updateCollabUi_()};Blockly.Realtime.doCommand=function(a){a()};Blockly.Realtime.genUid=function(a){var b=Blockly.Realtime.sessionId_+"-"+a;return Blockly.Realtime.blocksMap_.has(b)?Blockly.Realtime.genUid("-"+a):b};Blockly.Flyout=function(a){var b=this;a.getMetrics=function(){return b.getMetrics_()};a.setMetrics=function(a){return b.setMetrics_(a)};this.workspace_=new Blockly.WorkspaceSvg(a);this.workspace_.isFlyout=!0;this.RTL=!!a.RTL;this.eventWrappers_=[];this.buttons_=[];this.listeners_=[]};Blockly.Flyout.prototype.autoClose=!0;Blockly.Flyout.prototype.CORNER_RADIUS=8;Blockly.Flyout.prototype.SCROLLBAR_PADDING=2;Blockly.Flyout.prototype.width_=0;Blockly.Flyout.prototype.height_=0;
...
"block";for(var b=[],g=[],c=0;e=a[c];c++)e.tagName&&"BLOCK"==e.tagName.toUpperCase()&&(d=Blockly.Xml.domToBlock(this.workspace_,e),b.push(d),d=parseInt(e.getAttribute("gap"),10),g.push(d||3*f));a=f;for(c=0;d=b[c];c++){e=d.getDescendants();for(var h=0,k;k=e[h];h++)k.isInFlyout=!0,k.setCommentText(null);d.render();h=d.getSvgRoot();e=d.getHeightWidth();d.moveBy(this.RTL?0:f/this.workspace_.scale+Blockly.BlockSvg.TAB_WIDTH,a);a+=e.height+g[c];e=Blockly.createSvgElement("rect",{"fill-opacity":0},null);
this.workspace_.getCanvas().insertBefore(e,d.getSvgRoot());d.flyoutRect_=e;this.buttons_[c]=e;this.autoClose?this.listeners_.push(Blockly.bindEvent_(h,"mousedown",null,this.createBlockFunc_(d))):this.listeners_.push(Blockly.bindEvent_(h,"mousedown",null,this.blockMouseDown_(d)));this.listeners_.push(Blockly.bindEvent_(h,"mouseover",d,d.addSelect));this.listeners_.push(Blockly.bindEvent_(h,"mouseout",d,d.removeSelect));this.listeners_.push(Blockly.bindEvent_(e,"mousedown",null,this.createBlockFunc_(d)));
...
this.reflow);this.workspace_.fireChangeEvent()};
...
Blockly.Flyout.prototype.createBlockFunc_=function(a){var b=this,c=this.targetWorkspace_;return function(d){if(!Blockly.isRightButton(d)&&!a.disabled){var e=Blockly.Xml.blockToDom_(a),e=Blockly.Xml.domToBlock(c,e),f=a.getSvgRoot();if(!f)throw"originBlock is not rendered.";f=Blockly.getSvgXY_(f,c);if(b.RTL){var g=c.getMetrics().viewWidth-b.width_;f.x+=g/c.scale-g}else f.x+=b.workspace_.scrollX/b.workspace_.scale-b.workspace_.scrollX;f.y+=b.workspace_.scrollY/b.workspace_.scale-b.workspace_.scrollY;
g=e.getSvgRoot();if(!g)throw"block is not rendered.";g=Blockly.getSvgXY_(g,c);g.x+=c.scrollX/c.scale-c.scrollX;g.y+=c.scrollY/c.scale-c.scrollY;c.toolbox_&&!c.scrollbar&&(g.x+=c.toolbox_.width/c.scale);e.moveBy(f.x-g.x,f.y-g.y);b.autoClose?b.hide():b.filterForCapacity_();e.onMouseDown_(d)}}};
Blockly.Flyout.prototype.filterForCapacity_=function(){var a=this.targetWorkspace_.remainingCapacity(),b=this.workspace_.getTopBlocks(!1),c={};if(this.workspace_.targetWorkspace)for(var d=this.workspace_.targetWorkspace.getAllBlocks(),e=0;e<d.length;e++)d[e].isUnique&&(c[d[e].type]=1);for(e=0;d=b[e];e++){var f=d.getDescendants();(c[d.type]||f.length>a)&&d.setDisabled(!0)}};
...
Blockly.Toolbox.prototype.init=function(){var a=this.workspace_;this.HtmlDiv=goog.dom.createDom("div","blocklyToolboxDiv");this.HtmlDiv.setAttribute("dir",a.RTL?"RTL":"LTR");document.body.appendChild(this.HtmlDiv);Blockly.bindEvent_(this.HtmlDiv,"mousedown",this,function(a){Blockly.isRightButton(a)||a.target==this.HtmlDiv?Blockly.hideChaff(!1):Blockly.hideChaff(!0)});this.flyout_=new Blockly.Flyout({disabledPatternId:a.options.disabledPatternId,parentWorkspace:a,RTL:a.RTL,svg:a.options.svg});goog.dom.insertSiblingAfter(this.flyout_.createDom(),
a.svgGroup_);this.flyout_.init(a);this.CONFIG_.cleardotPath=a.options.pathToMedia+"1x1.gif";this.CONFIG_.cssCollapsedFolderIcon="blocklyTreeIconClosed"+(a.RTL?"Rtl":"Ltr");var b=new Blockly.Toolbox.TreeControl(this,this.CONFIG_);this.tree_=b;b.setShowRootNode(!1);b.setShowLines(!1);b.setShowExpandIcons(!1);b.setSelectedItem(null);this.hasColours_=!1;this.populate_(a.options.languageTree);b.render(this.HtmlDiv);this.hasColours_&&this.addColour_(b);this.position()};
...
Blockly.Toolbox.prototype.populate_=function(a){function b(a,f){for(var g=0,h;h=a.childNodes[g];g++)if(h.tagName)switch(h.tagName.toUpperCase()){case "CATEGORY":var k=c.createNode(h.getAttribute("name"));k.blocks=[];f.add(k);var l=h.getAttribute("custom");l?k.blocks=l:b(h,k);l=h.getAttribute("colour");goog.isString(l)?(k.hexColour=Blockly.makeColour(l),d=!0):k.hexColour="";"true"==h.getAttribute("expanded")&&(k.blocks.length&&c.setSelectedItem(k),k.setExpanded(!0));break;case "SEP":f.add(new Blockly.Toolbox.TreeSeparator);
break;case "BLOCK":f.blocks.push(h)}}var c=this.tree_;c.removeChildren();c.blocks=[];var d=!1;b(a,this.tree_);this.hasColours_=d;if(c.blocks.length)throw"Toolbox cannot have both blocks and categories in the root level.";Blockly.fireUiEvent(window,"resize")};Blockly.Toolbox.prototype.addColour_=function(a){a=a.getChildren();for(var b=0,c;c=a[b];b++){var d=c.getRowElement();if(d){var e="8px solid "+(c.hexColour||"#ddd");this.workspace_.RTL?d.style.borderRight=e:d.style.borderLeft=e}this.addColour_(c)}};
...
Blockly.Toolbox.TreeSeparator.CONFIG_={cssTreeRow:"blocklyTreeSeparator"};Blockly.TypeBlock=function(a){Blockly.TypeBlock.typeBlockDiv_=goog.dom.getElement(a.typeBlockDiv);Blockly.TypeBlock.inputText_=goog.dom.getElement(a.inputText);Blockly.TypeBlock.createAutoComplete_()};Blockly.TypeBlock.typeBlockDiv_=null;Blockly.TypeBlock.inputText_=null;Blockly.TypeBlock.visible=!1;Blockly.TypeBlock.TBOptions_={};Blockly.TypeBlock.TBOptionsNames_=[];Blockly.TypeBlock.ac_=null;Blockly.TypeBlock.currentListener_=null;
Blockly.TypeBlock.onKeyDown_=function(a){!Blockly.TypeBlock.typeBlockDiv_||a.altKey||a.ctrlKey||a.metaKey||a.keycode===goog.events.KeyCodes.TAB||(goog.style.isElementShown(Blockly.TypeBlock.typeBlockDiv_)?(a.keyCode==goog.events.KeyCodes.ESC&&Blockly.TypeBlock.hide(),a.keyCode===goog.events.KeyCodes.ENTER&&Blockly.TypeBlock.hide()):goog.events.KeyCodes.isCharacterKey(a.keyCode)&&(0==Blockly.latestClick.x&&0==Blockly.latestClick.y&&(Blockly.latestClick.x=300,Blockly.latestClick.y=250),Blockly.TypeBlock.show(),
a.preventDefault(),Blockly.TypeBlock.inputText_.value="undefined"===typeof a.key||"MozPrintableKey"===a.key?String.fromCharCode(0!==a.charCode?a.charCode:a.keyCode):a.key))};Blockly.TypeBlock.hide=function(){Blockly.TypeBlock.visible&&(Blockly.TypeBlock.visible=!1,Blockly.TypeBlock.ac_.dismiss(),goog.style.showElement(Blockly.TypeBlock.typeBlockDiv_,!1))};
Blockly.TypeBlock.show=function(){if(!Blockly.TypeBlock.visible){Blockly.TypeBlock.lazyLoadOfOptions_();var a=Blockly.TypeBlock.ac_.getSelectionHandler(),b=Blockly.getMainWorkspace().options.svg,c=goog.style.getPageOffset(b),b=Blockly.latestClick.x-c.x,c=Blockly.latestClick.y-c.y;0>=b&&(b=300);0>=c&&(c=150);goog.style.setPosition(Blockly.TypeBlock.typeBlockDiv_,b,c);goog.style.showElement(Blockly.TypeBlock.typeBlockDiv_,!0);Blockly.TypeBlock.inputText_.value="";Blockly.TypeBlock.inputText_.focus();
a.processFocus(Blockly.TypeBlock.inputText_);Blockly.TypeBlock.visible=!0}};Blockly.TypeBlock.needsReload={components:!0};Blockly.TypeBlock.lazyLoadOfOptions_=function(){this.needsReload.components&&(Blockly.TypeBlock.generateOptions(),this.needsReload.components=null);Blockly.TypeBlock.loadGlobalVariables_();Blockly.TypeBlock.loadProcedures_();this.reloadOptionsAfterChanges_()};
Blockly.TypeBlock.generateOptions=function(){Blockly.TypeBlock.TBOptions_=function(){function a(a,c){a&&goog.array.forEach(a,function(a){var d={},e={},f={};a.fields&&(d=a.fields);a.values&&(f=a.values);a.mutatorAttributes&&(e=a.mutatorAttributes);b[a.entry]={canonicName:c,mutatorAttributes:e,fields:d,values:f}})}var b={},c,d;for(d in Blockly.Blocks){var e=Blockly.Blocks[d];e.typeblock&&(c=e.typeblock,"function"==typeof e.typeblock?c=e.typeblock():"string"===typeof e.typeblock&&(c=[{entry:e.typeblock}]),
a(c,d))}return b}()};Blockly.TypeBlock.reloadOptionsAfterChanges_=function(){Blockly.TypeBlock.TBOptionsNames_=goog.object.getKeys(Blockly.TypeBlock.TBOptions_);goog.array.sort(Blockly.TypeBlock.TBOptionsNames_);Blockly.TypeBlock.ac_.matcher_.setRows(Blockly.TypeBlock.TBOptionsNames_)};
Blockly.TypeBlock.loadProcedures_=function(){Blockly.TypeBlock.TBOptions_=goog.object.filter(Blockly.TypeBlock.TBOptions_,function(a){return!a.isProcedure});var a=Blockly.Procedures.allProcedures(Blockly.mainWorkspace);goog.array.forEach(a[0],function(a){var c=goog.string.trim(Blockly.Msg.PROCEDURES_CALLNORETURN_CALL+" ")+a[0];Blockly.TypeBlock.TBOptions_[c]={canonicName:"procedures_callnoreturn",fields:{NAME:a[0]},isProcedure:!0}});goog.array.forEach(a[1],function(a){var c=goog.string.trim(Blockly.Msg.PROCEDURES_CALLRETURN_CALL+
" ")+a[0];Blockly.TypeBlock.TBOptions_[c]={canonicName:"procedures_callreturn",fields:{NAME:a[0]},isProcedure:!0}})};
Blockly.TypeBlock.loadGlobalVariables_=function(){Blockly.TypeBlock.TBOptions_=goog.object.filter(Blockly.TypeBlock.TBOptions_,function(a){return!a.isGlobalvar});var a=Blockly.Variables.allVariables(Blockly.mainWorkspace);goog.array.forEach(a,function(a){Blockly.TypeBlock.TBOptions_["get "+a]={canonicName:"variables_get",fields:{VAR:a},isGlobalvar:!0};Blockly.TypeBlock.TBOptions_["set "+a]={canonicName:"variables_set",fields:{VAR:a},isGlobalvar:!0}})};
Blockly.TypeBlock.mutatorToXMLString=function(a){var b="";if("object"===typeof a&&!goog.object.isEmpty(a)){var c="<mutation ",d;for(d in a)a.hasOwnProperty(d)&&(b+=c+d+'="'+a[d]+'"',c=" ");b+="></mutation>"}return b};Blockly.TypeBlock.sectionToXMLString=function(a,b){var c="";if("object"===typeof b)for(var d in b)if(b.hasOwnProperty(d)){var e=b[d];"value"===a&&goog.isNumber(e)&&(e='<shadow type="math_number"><field name="NUM">'+e+"</field></shadow>");c+="<"+a+' name="'+d+'">'+e+"</"+a+">"}return c};
Blockly.TypeBlock.autoCompleteSelected=function(){var a=Blockly.TypeBlock.inputText_.value,b=goog.object.get(Blockly.TypeBlock.TBOptions_,a);if(!b){var b=RegExp("^-?[0-9]\\d*(.\\d+)?$","g").exec(a),c=RegExp("^[\"|']+","g").exec(a);if(b&&0<b.length)b={canonicName:"math_number",fields:{NUM:a}};else if(c&&1===c.length)b={canonicName:"text",fields:{TEXT:a.substring(1)}};else return}a='<xml><block type="'+b.canonicName+'">'+Blockly.TypeBlock.mutatorToXMLString(b.mutatorAttributes)+Blockly.TypeBlock.sectionToXMLString("field",
b.fields)+Blockly.TypeBlock.sectionToXMLString("value",b.values)+"</block></xml>";a=Blockly.Xml.textToDom(a).firstChild;a=Blockly.Xml.domToBlock(Blockly.mainWorkspace,a);a.render();(b=Blockly.selected)?(b.getRelativeToSurfaceXY(),Blockly.TypeBlock.connectIfPossible(b,a),a.parentBlock_||a.moveBy(Blockly.selected.getRelativeToSurfaceXY().x+110,Blockly.selected.getRelativeToSurfaceXY().y+50)):(b=Blockly.getMainWorkspace().options.svg,b=goog.style.getPageOffset(b),c=Blockly.getMainWorkspace().toolbox_.width,
c=Blockly.mainWorkspace.getMetrics().viewLeft+Blockly.latestClick.x-b.x-c,b=Blockly.mainWorkspace.getMetrics().viewTop+Blockly.latestClick.y-b.y,a.moveBy(c,b));a.select();Blockly.TypeBlock.hide()};
Blockly.TypeBlock.createAutoComplete_=function(){Blockly.TypeBlock.TBOptionsNames_=goog.object.getKeys(Blockly.TypeBlock.TBOptions_);goog.array.sort(Blockly.TypeBlock.TBOptionsNames_);goog.events.unlistenByKey(Blockly.TypeBlock.currentListener_);Blockly.TypeBlock.ac_&&Blockly.TypeBlock.ac_.dispose();var a=new Blockly.TypeBlock.ac.AIArrayMatcher(Blockly.TypeBlock.TBOptionsNames_,!1),b=new goog.ui.ac.Renderer,c=new goog.ui.ac.InputHandler(null,null,!1);Blockly.TypeBlock.ac_=new goog.ui.ac.AutoComplete(a,
b,c);Blockly.TypeBlock.ac_.setMaxMatches(100);c.attachAutoComplete(Blockly.TypeBlock.ac_);c.attachInputs(Blockly.TypeBlock.inputText_);Blockly.TypeBlock.currentListener_=goog.events.listen(Blockly.TypeBlock.ac_,goog.ui.ac.AutoComplete.EventType.UPDATE,Blockly.TypeBlock.autoCompleteSelected);goog.events.listen(Blockly.TypeBlock.ac_,goog.ui.ac.AutoComplete.EventType.DISMISS,Blockly.TypeBlock.hide)};
Blockly.TypeBlock.connectIfPossible=function(a,b){for(var c=0,d=a.inputList,e=d.length,c=0;c<e;c++)try{if(null!=b.outputConnection){if(d[c].connection&&d[c].connection.checkType_(b.outputConnection)&&!d[c].connection.targetConnection){b.outputConnection.connect(d[c].connection);break}}else b.previousConnection.connect(d[c].connection)}catch(f){}null===b.parentBlock_&&(b.previousConnection&&a.nextConnection&&null==a.outputConnection&&null==b.outputConnection?b.previousConnection.connect(a.nextConnection):
a.parentBlock_&&(null==a.parentBlock_.outputConnection?null==b.outputConnection&&a.parentBlock_.nextConnection.connect(b.previousConnection):Blockly.TypeBlock.connectIfPossible(a.parentBlock_,b)))};Blockly.TypeBlock.ac={};Blockly.TypeBlock.ac.AIArrayMatcher=function(a,b){goog.ui.ac.ArrayMatcher.call(a,b);this.rows_=a;this.useSimilar_=!b};goog.inherits(Blockly.TypeBlock.ac.AIArrayMatcher,goog.ui.ac.ArrayMatcher);
Blockly.TypeBlock.ac.AIArrayMatcher.prototype.requestMatchingRows=function(a,b,c,d){d=this.getPrefixMatches(a,b);if("text"===a||"Text"===a)goog.array.remove(d,"Text"),goog.array.insertAt(d,"Text",0);var e=RegExp("^-?[0-9]\\d*(.\\d+)?$","g").exec(a);e&&0<e.length&&d.push(a);(e=RegExp("^[\"|']+","g").exec(a))&&1===e.length&&d.push(a);0===d.length&&this.useSimilar_&&(d=this.getSimilarRows(a,b));c(a,d)};Blockly.Css={};Blockly.Css.Cursor={OPEN:"handopen",CLOSED:"handclosed",DELETE:"handdelete"};Blockly.Css.currentCursor_="";Blockly.Css.styleSheet_=null;Blockly.Css.mediaPath_="";
...
Blockly.WidgetDiv.hideIfOwner=function(a){Blockly.WidgetDiv.owner_==a&&Blockly.WidgetDiv.hide()};Blockly.WidgetDiv.position=function(a,b,c,d,e){b<d.y&&(b=d.y);e?a>c.width+d.x&&(a=c.width+d.x):a<d.x&&(a=d.x);Blockly.WidgetDiv.DIV.style.left=a+"px";Blockly.WidgetDiv.DIV.style.top=b+"px";Blockly.WidgetDiv.DIV.style.height=c.height-b+d.y+"px"};Blockly.WidgetDiv.onKeyDown_=function(a){};Blockly.inject=function(a,b){goog.isString(a)&&(a=document.getElementById(a));if(!goog.dom.contains(document,a))throw"Error: container is not in current document.";var c=Blockly.parseOptions_(b||{}),d,e=function(){var b=Blockly.createDom_(a,c);d=Blockly.createMainWorkspace_(b,c);Blockly.init_(d);d.markFocused();Blockly.bindEvent_(b,"focus",d,d.markFocused)};if(c.enableRealtime){var f=document.getElementById("realtime");f&&(f.style.display="block");Blockly.Realtime.startRealtime(e,a,c.realtimeOptions,
c.pathToMedia)}else e();return d};Blockly.parseToolboxTree_=function(a){a?("string"!=typeof a&&"undefined"==typeof XSLTProcessor&&(a=a.outerHTML),"string"==typeof a&&(a=Blockly.Xml.textToDom(a))):a=null;return a};
Blockly.parseOptions_=function(a){var b=!!a.readOnly;if(b)var c=null,d=!1,e=!1,f=!1,g=!1,h=!1,k=!1,l=!0,n=!1,m="";else c=Blockly.parseToolboxTree_(a.toolbox),d=Boolean(c&&c.getElementsByTagName("category").length),e=a.trashcan,void 0===e&&(e=d),f=a.collapse,void 0===f&&(f=d),g=a.comments,void 0===g&&(g=d),h=a.disable,void 0===h&&(h=d),k=a.sounds,void 0===k&&(k=!0),n=a.mutators,void 0===n&&(n=!1),l=a.disconnected,void 0===l&&(l=!0),m=a.appTitle,void 0===m&&(m="");var p=a.scrollbars;void 0===p&&(p=
d);var q=a.css;void 0===q&&(q=!0);var r=a.grid||{},u={};u.spacing=parseFloat(r.spacing)||0;u.colour=r.colour||"#888";u.length=parseFloat(r.length)||1;u.snap=0<u.spacing&&!!r.snap;r="https://blockly-demo.appspot.com/static/media/";a.media?r=a.media:a.path&&(r=a.path+"media/");var t=a.zoom||{},v={};v.controls=void 0===t.controls?!1:!!t.controls;v.wheel=void 0===t.wheel?!1:!!t.wheel;v.startScale=void 0===t.startScale?1:parseFloat(t.startScale);v.maxScale=void 0===t.maxScale?3:parseFloat(t.maxScale);
v.minScale=void 0===t.minScale?.3:parseFloat(t.minScale);v.scaleSpeed=void 0===t.scaleSpeed?1.2:parseFloat(t.scaleSpeed);t=!!a.realtime;return{RTL:!!a.rtl,collapse:f,comments:g,disable:h,readOnly:b,maxBlocks:a.maxBlocks||Infinity,pathToMedia:r,hasCategories:d,hasScrollbars:p,hasTrashcan:e,hasSounds:k,hasCss:q,disableDisconnected:!l,useMutators:n,appTitle:m,languageTree:c,gridOptions:u,zoomOptions:v,enableRealtime:t,realtimeOptions:t?a.realtimeOptions:void 0}};
...
{stroke:b.gridOptions.colour},d),1<b.gridOptions.length&&Blockly.createSvgElement("line",{stroke:b.gridOptions.colour},d));b.gridPattern=d;return b.svg=c};
...
Blockly.getSvgXY_=function(a,b){var c=0,d=0,e=1;if(goog.dom.contains(b.getCanvas(),a)||goog.dom.contains(b.getBubbleCanvas(),a))e=b.scale;do{var f=Blockly.getRelativeXY_(a);if(a==b.getCanvas()||a==b.getBubbleCanvas())e=1;c+=f.x*e;d+=f.y*e;a=a.parentNode}while(a&&a!=b.options.svg);return new goog.math.Coordinate(c,d)};
Blockly.createSvgElement=function(a,b,c,d){a=document.createElementNS(Blockly.SVG_NS,a);for(var e in b)a.setAttribute(e,b[e]);document.body.runtimeStyle&&(a.runtimeStyle=a.currentStyle=a.style);c&&c.appendChild(a);return a};Blockly.removeAllRanges=function(){window.getSelection&&setTimeout(function(){try{var a=window.getSelection();a.isCollapsed||a.removeAllRanges()}catch(b){}},0)};Blockly.isRightButton=function(a){return a.ctrlKey&&goog.userAgent.MAC?!0:2==a.button};
...
Blockly.getMsgString=function(a){var b=null;"object"===typeof MSG&&(b=MSG[a]);b||(b=Blockly.Msg[a]);b||(console.log("Missing message for "+a),b="\u226a"+a+"\u226b");return b};Blockly.getToolTipString=function(a){var b=null;"object"===typeof ToolTips&&(b=ToolTips[a]);b||(console.log("Missing tool tip for "+a),b="\u226a"+a+"\u226b");return b};Blockly.getUrlString=function(a){var b=null;"object"===typeof Urls&&(b=Urls[a]);b||(console.log("Missing URL for "+a),b="\u226a"+a+"\u226b");return b};
Blockly.getBlockHue=function(a){var b=null;"object"===typeof HUES&&(b=HUES[a]);b||(console.log("Missing hue for "+a),b=260);return b};var CLOSURE_DEFINES={"goog.DEBUG":!1};Blockly.SVG_NS="http://www.w3.org/2000/svg";Blockly.HTML_NS="http://www.w3.org/1999/xhtml";Blockly.HSV_SATURATION=.45;Blockly.HSV_VALUE=.65;Blockly.SPRITE={width:96,height:124,url:"sprites.png"};Blockly.makeColour=function(a){return goog.color.hsvToHex(a,Blockly.HSV_SATURATION,255*Blockly.HSV_VALUE)};Blockly.INPUT_VALUE=1;Blockly.OUTPUT_VALUE=2;Blockly.NEXT_STATEMENT=3;Blockly.PREVIOUS_STATEMENT=4;Blockly.DUMMY_INPUT=5;Blockly.ALIGN_LEFT=-1;
Blockly.ALIGN_CENTRE=0;Blockly.ALIGN_RIGHT=1;Blockly.OPPOSITE_TYPE=[];Blockly.OPPOSITE_TYPE[Blockly.INPUT_VALUE]=Blockly.OUTPUT_VALUE;Blockly.OPPOSITE_TYPE[Blockly.OUTPUT_VALUE]=Blockly.INPUT_VALUE;Blockly.OPPOSITE_TYPE[Blockly.NEXT_STATEMENT]=Blockly.PREVIOUS_STATEMENT;Blockly.OPPOSITE_TYPE[Blockly.PREVIOUS_STATEMENT]=Blockly.NEXT_STATEMENT;Blockly.selected=null;Blockly.selectedField=null;Blockly.highlightedConnection_=null;Blockly.localConnection_=null;Blockly.DRAG_RADIUS=5;
Blockly.SNAP_RADIUS=20;Blockly.BUMP_DELAY=250;Blockly.COLLAPSE_CHARS=30;Blockly.LONGPRESS=750;Blockly.mainWorkspace=null;Blockly.clipboardXml_=null;Blockly.clipboardSource_=null;Blockly.dragMode_=0;Blockly.onTouchUpWrapper_=null;Blockly.latestClick={x:0,y:0};Blockly.svgSize=function(a){return{width:a.cachedWidth_,height:a.cachedHeight_}};Blockly.scopeVariableList={Types:["String","Number","Boolean","Array","Map"]};Blockly.VariableTypeEquivalence={};
...
Blockly.onKeyDown_=function(a){if(a.keyCode==goog.events.KeyCodes.TAB&&Blockly.WidgetDiv.isVisible())Blockly.WidgetDiv.hide();else if(Blockly.isTargetInput_(a))return;var b=!1;if(a.keyCode==goog.events.KeyCodes.ESC)Blockly.hideChaff(),Blockly.selectField(null);else if(a.keyCode==goog.events.KeyCodes.TAB)a.shiftKey?Blockly.selectPrevField():Blockly.selectNextField();else if(a.keyCode==goog.events.KeyCodes.BACKSPACE||a.keyCode==goog.events.KeyCodes.DELETE)try{Blockly.selected&&Blockly.selected.isDeletable()&&
(b=!0)}finally{a.preventDefault()}else if(a.altKey||a.ctrlKey||a.metaKey){var c=!1;if(Blockly.selected&&Blockly.selected.isDeletable()&&Blockly.selected.isMovable()){var d=Math.round(.5+(Blockly.selected.workspace.scale*Blockly.SNAP_RADIUS+1));a.keyCode===goog.events.KeyCodes.C?(Blockly.hideChaff(),Blockly.copy_(Blockly.selected),c=!0):a.keyCode===goog.events.KeyCodes.X?(Blockly.copy_(Blockly.selected),b=c=!0):a.altKey&&a.keyCode===goog.events.KeyCodes.RIGHT?Blockly.selected.moveByKey(d,0):a.altKey&&
a.keyCode===goog.events.KeyCodes.LEFT?Blockly.selected.moveByKey(-d,0):a.altKey&&a.keyCode===goog.events.KeyCodes.DOWN?Blockly.selected.moveByKey(0,d):a.altKey&&a.keyCode===goog.events.KeyCodes.UP&&Blockly.selected.moveByKey(0,-d)}a.keyCode==goog.events.KeyCodes.V&&Blockly.clipboardXml_&&(Blockly.clipboardSource_.paste(Blockly.clipboardXml_),c=!0);if(!c&&a.metaKey&&a.keyCode&&Blockly.selected&&Blockly.selected.contextMenu)for(c=Blockly.selected.buildContextMenu_(),d=0;d<c.length;d++)if(c[d].enabled&&
c[d].accel==a.keyCode){Blockly.doCommand(c[d].callback);break}}else if(Blockly.WidgetDiv.isVisible())Blockly.WidgetDiv.onKeyDown_(a);else if((c=Blockly.selected)&&a.shiftKey&&(a.keyCode===goog.events.KeyCodes.RIGHT||a.keyCode===goog.events.KeyCodes.LEFT||a.keyCode===goog.events.KeyCodes.UP||a.keyCode===goog.events.KeyCodes.DOWN))Blockly.selectNearestBlock(c,a.keyCode);else if(c&&a.keyCode===(c.RTL?goog.events.KeyCodes.RIGHT:goog.events.KeyCodes.LEFT))Blockly.selectPrevBlock();else if(c&&a.keyCode===
(c.RTL?goog.events.KeyCodes.LEFT:goog.events.KeyCodes.RIGHT))Blockly.selectNextBlock();else if(c&&a.keyCode===goog.events.KeyCodes.UP)Blockly.selectParentBlock();else if(c&&a.keyCode===goog.events.KeyCodes.DOWN)Blockly.selectChildBlock();else if(c&&a.keyCode===goog.events.KeyCodes.SPACE){var d=goog.style.getBoundingClientRect_(c.svgGroup_),e=Blockly.SNAP_RADIUS*c.workspace.scale;a.clientX=c.RTL?d.right-e:d.left+e;a.clientY=d.top+e;Blockly.selectBlock(Blockly.selected);Blockly.selected.showContextMenu_(a)}else Blockly.TypeBlock.onKeyDown_(a);
b&&(Blockly.hideChaff(),Blockly.selected.dispose(2!=Blockly.dragMode_,!0),Blockly.highlightedConnection_&&(Blockly.highlightedConnection_.unhighlight(),Blockly.highlightedConnection_=null))};Blockly.selectBlock=function(a){if(a){a.select();var b=a.getRelativeToSurfaceXY(),c=a.width,d={top:b.y,bottom:b.y+a.height};a.RTL?(d.left=b.x-c,d.right=b.x):(d.left=b.x,d.right=b.x+c);a.workspace.scrollToArea(d,a.RTL)}};
Blockly.selectNearestBlock=function(a,b){var c=0,d=0,e=0,f=0;b==goog.events.KeyCodes.RIGHT?(c=e=1,d=.5):b==goog.events.KeyCodes.LEFT?(e=-1,d=.5):b==goog.events.KeyCodes.UP?(f=-1,c=.5):b==goog.events.KeyCodes.DOWN&&(f=1,c=.5,d=0);a.RTL&&(c=-c);var g=a.getRelativeToSurfaceXY();g.x+=a.width*c;g.y+=a.height*d;for(var h=a.workspace.getAllBlocks(),k=null,l=null,n=0;n<h.length;n++){var m=h[n].getRelativeToSurfaceXY();m.x+=a.width*c;m.y+=a.height*d;var p=m.x-g.x,m=m.y-g.y;0<p*e+m*f&&(p=Math.sqrt(p*p+m*m),
null==l||p<l)&&(l=p,k=h[n])}k&&Blockly.selectBlock(k)};Blockly.selectField=function(a){if(Blockly.selectedField=a){var b=a.sourceBlock_;b.select();var c=b.getRelativeToSurfaceXY(),d=b.width,e={top:c.y,bottom:c.y+b.height};b.RTL?(e.left=c.x-d,e.right=c.x):(e.left=c.x,e.right=c.x+d);b.workspace.scrollToArea(e,b.RTL);if(e=a.getSvgRoot()){var f=Blockly.getRelativeXY_(e),e={top:c.y+f.y,bottom:c.y+b.height};b.RTL?(e.left=c.x-d,e.right=c.x-f.x):(e.left=c.x+f.x,e.right=c.x+d);b.workspace.scrollToArea(e,b.RTL)}a.showEditor_()}};
...
Blockly.selectPrevField=function(){for(var a=Blockly.selectedField,b=Blockly.selected,c=null;null===c;){b||(b=Blockly.findNextBlock(null),a=null);if(!b)break;var d=b.getEditableFields();if(d.length){var e=d.length-1;a&&(e=goog.array.indexOf(d,a)-1,0>e&&(e=-1));-1!==e&&(c=d[e])}if(null===c&&(b=Blockly.findPrevBlock(b),a=null,b==Blockly.selected))break}Blockly.selectField(c)};Blockly.selectNextBlock=function(){var a=Blockly.findNextBlock(Blockly.selected);Blockly.selectField(null);Blockly.selectBlock(a)};
Blockly.findNextTopBlock=function(a){var b=null,c=Blockly.getMainWorkspace().getTopBlocks(!0);0<c.length&&(a=goog.array.indexOf(c,a)+1,0<a&&(a===c.length&&(a=0),b=c[a]));return b};Blockly.findNextBlock=function(a){for(var b=null,c=null;null!=a&&null===b;){var d=[];a.isCollapsed()||(d=a.getOrderedChildren());var e=0;0<d.length&&(e=goog.array.indexOf(d,c)+1);e<d.length?b=d[e]:(c=a,a=a.getParent())}null===b&&(b=Blockly.findNextTopBlock(c));return b};
Blockly.selectPrevBlock=function(){var a=Blockly.findPrevBlock(Blockly.selected);Blockly.selectField(null);Blockly.selectBlock(a)};Blockly.findPrevTopBlock=function(a){var b=null,c=Blockly.getMainWorkspace().getTopBlocks(!0);0<c.length&&(a=goog.array.indexOf(c,a),0<=a&&(0===a&&(a=c.length),b=c[a-1]));return b};
Blockly.findPrevBlock=function(a){var b=null,c=null;null!=a&&(c=a.getParent(),null===c&&(c=Blockly.findPrevTopBlock(a)));for(;null!=c&&null===b;){var d=[];c.isCollapsed()||(d=c.getOrderedChildren());if(0===d.length)b=c;else{var e=goog.array.indexOf(d,a);0===e?b=c:(-1===e&&(e=d.length),a=null,c=d[e-1])}}return b};
Blockly.selectParentBlock=function(){var a=null,b=null,c=Blockly.selected;if(null!=c&&(null!=c.previousConnection&&(a=c.previousConnection.targetBlock()),null===a&&(b=c.getSurroundParent(),null!=b))){var d=[];b.isCollapsed()||b.getInputsInline()||(d=b.getOrderedChildren());if(0<=d.length){var e=goog.array.indexOf(d,c);0<e&&(a=d[e-1])}null===a&&(a=b)}null===a&&(a=Blockly.findPrevTopBlock(c));Blockly.selectField(null);Blockly.selectBlock(a)};
Blockly.selectChildBlock=function(){var a=null,b=null,c=Blockly.selected;if(null!=c&&(a=c.getNextBlock(),null===a&&(b=c.getSurroundParent(),null!=b))){var d=[];b.isCollapsed()||b.getInputsInline()||(d=b.getOrderedChildren());if(0<=d.length){var e=goog.array.indexOf(d,c);0<=e&&e<d.length-1&&(a=d[e+1])}null===a&&(a=b)}null===a&&(a=Blockly.findNextTopBlock(c));Blockly.selectField(null);Blockly.selectBlock(a)};Blockly.terminateDrag_=function(){Blockly.BlockSvg.terminateDrag_();Blockly.Flyout.terminateDrag_()};
...
Blockly.onContextMenu_=function(a){Blockly.isTargetInput_(a)||a.preventDefault()};Blockly.hideChaff=function(a){Blockly.Tooltip.hide();Blockly.WidgetDiv.hide();Blockly.TypeBlock.hide();a||(a=Blockly.getMainWorkspace(),a.toolbox_&&a.toolbox_.flyout_&&a.toolbox_.flyout_.autoClose&&a.toolbox_.clearSelection())};
...
"_index",Blockly.Variables.NAME_TYPE);d=Blockly.JavaScript.INDENT+b+" = "+e+"["+c+"];\n"+d;return a+("for (var "+c+" in "+e+") {\n"+d+"}\n")};Blockly.JavaScript.controls_flow_statements=function(a){switch(a.getFieldValue("FLOW")){case "BREAK":return"break;\n";case "CONTINUE":return"continue;\n"}throw"Unknown flow statement.";};Blockly.JavaScript.maps={};Blockly.JavaScript.maps_create_empty=function(a){return["{}",Blockly.JavaScript.ORDER_ATOMIC]};
Blockly.JavaScript.maps_create_with=function(a){var b=Blockly.JavaScript.variableDB_.getDistinctName("hashMap",Blockly.Variables.NAME_TYPE),c;Blockly.JavaScript.stashStatement(b+" = {};\n");for(var d=0;d<a.itemCount_;d++){var e="ADD"+d;if(c=a.getInputTargetBlock(e))if("maps_create"===c.type)e=Blockly.JavaScript.valueToCode(c,"VAL",Blockly.JavaScript.ORDER_NONE)||"null",c=Blockly.JavaScript.valueToCode(c,"KEY",Blockly.JavaScript.ORDER_NONE)||'""',c=b+"["+c+"] = "+e+";\n",Blockly.JavaScript.stashStatement(c);
else if(c=Blockly.JavaScript.valueToCode(a,e,Blockly.JavaScript.ORDER_NONE))c="$.extend({}, "+b+", "+c+");\n",Blockly.JavaScript.stashStatement(c)}return[b,Blockly.JavaScript.ORDER_ATOMIC]};Blockly.JavaScript.maps_length=function(a){return[(Blockly.JavaScript.valueToCode(a,"MAP",Blockly.JavaScript.ORDER_NONE)||"{}")+".length",Blockly.JavaScript.ORDER_FUNCTION_CALL]};
Blockly.JavaScript.maps_isempty=function(a){a=Blockly.JavaScript.valueToCode(a,"MAP",Blockly.JavaScript.ORDER_NONE)||"";var b=a+".length == 0";""===a&&(b="true");return[b,Blockly.JavaScript.ORDER_LOGICAL_NOT]};
Blockly.JavaScript.maps_create=function(a){var b=Blockly.JavaScript.valueToCode(a,"VAL",Blockly.JavaScript.ORDER_NONE)||"null";a=Blockly.JavaScript.valueToCode(a,"KEY",Blockly.JavaScript.ORDER_NONE)||'""';var c=Blockly.JavaScript.variableDB_.getDistinctName("hashMap",Blockly.Variables.NAME_TYPE);Blockly.JavaScript.stashStatement(c+" = {};\n"+c+"["+a+"] = "+b+";\n");return[c,Blockly.JavaScript.ORDER_LOGICAL_NOT]};
Blockly.JavaScript.maps_getIndex=function(a){var b=a.getFieldValue("MODE")||"GET",c=Blockly.JavaScript.valueToCode(a,"KEY",Blockly.JavaScript.ORDER_NONE)||'""';a=Blockly.JavaScript.valueToCode(a,"MAP",Blockly.JavaScript.ORDER_MEMBER)||"";if("GET"==b)return[a+"["+c+"]",Blockly.JavaScript.ORDER_MEMBER];if("GET_REMOVE"==b)return b=a+"["+c+"];\n"+("delete "+a+"["+c+"]"),[b,Blockly.JavaScript.ORDER_FUNCTION_CALL];if("REMOVE"==b)return"delete "+a+"["+c+"];\n";throw"Unhandled combination (maps_getIndex).";
};Blockly.JavaScript.maps_setIndex=function(a){var b=Blockly.JavaScript.valueToCode(a,"MAP",Blockly.JavaScript.ORDER_MEMBER)||"{}",c=Blockly.JavaScript.valueToCode(a,"VAL",Blockly.JavaScript.ORDER_NONE)||"null";a=Blockly.JavaScript.valueToCode(a,"KEY",Blockly.JavaScript.ORDER_NONE)||'""';return b+"["+a+"] = "+c+";\n"};Blockly.JavaScript.maps_keys=function(a){return["Object.keys("+(Blockly.JavaScript.valueToCode(a,"MAP",Blockly.JavaScript.ORDER_NONE)||"{}")+")",Blockly.JavaScript.ORDER_LOGICAL_NOT]};
Blockly.JavaScript.controls_forEachKey=Blockly.JavaScript.controls_forEach;Blockly.JavaScript.math={};Blockly.JavaScript.math_number=function(a){return[parseFloat(a.getFieldValue("NUM")),Blockly.JavaScript.ORDER_ATOMIC]};
...
Blockly.JavaScript.text_prompt=Blockly.JavaScript.text_prompt_ext;Blockly.JavaScript.text_comment=function(a){return["/*\n"+(a.getFieldValue("COMMENT")||"")+"\n*/\n",Blockly.JavaScript.ORDER_FUNCTION_CALL]};Blockly.JavaScript.variables={};Blockly.JavaScript.variables_get=function(a){return[Blockly.JavaScript.variableDB_.getName(a.getFieldValue("VAR"),Blockly.Variables.NAME_TYPE),Blockly.JavaScript.ORDER_ATOMIC]};Blockly.JavaScript.variables_set=function(a){var b=Blockly.JavaScript.valueToCode(a,"VALUE",Blockly.JavaScript.ORDER_ASSIGNMENT)||"0";return Blockly.JavaScript.variableDB_.getName(a.getFieldValue("VAR"),Blockly.Variables.NAME_TYPE)+" = "+b+";\n"};
Blockly.JavaScript.hash_variables_get=function(a){var b=Blockly.JavaScript.variableDB_.getName(a.getFieldValue("VAR"),Blockly.Variables.NAME_TYPE);a=Blockly.JavaScript.quote_(a.getFieldValue("HASHKEY"));return[b+"["+a+"]",Blockly.JavaScript.ORDER_ATOMIC]};
Blockly.JavaScript.hash_variables_set=function(a){var b=Blockly.JavaScript.valueToCode(a,"VALUE",Blockly.JavaScript.ORDER_NONE)||"0",c=Blockly.JavaScript.variableDB_.getName(a.getFieldValue("VAR"),Blockly.Variables.NAME_TYPE);a=Blockly.JavaScript.quote_(a.getFieldValue("HASHKEY"));return c+"["+a+"] = "+b+"\n"};